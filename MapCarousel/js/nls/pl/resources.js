define({
  "app": {
    ...
    "errors": {
      "noMaps": "ł_This group does not contain any public web maps to display__________________ą",
      "noGroup": "ł_Group not found______ą",
      "createGroup": "ł_Unable to create group________ą",
