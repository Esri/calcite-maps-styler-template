define({
  "app": {
    ...
    "errors": {
      "noMaps": "ı_This group does not contain any public web maps to display__________________İ",
      "noGroup": "ı_Group not found______İ",
      "createGroup": "ı_Unable to create group________İ",
