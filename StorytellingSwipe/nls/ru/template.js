...
({
		viewer: {
			...
			errors: {
				...
				initMobile: "Добро пожаловать в веб-приложение Шторка. Приложение не настроено. Компоновщик не поддерживается на мобильных устройствах.",
				noBuilderIE8: "Компоновщик Шторка не поддерживается в браузере Internet Explorer в версиях ранее 9.",
				noLayerView: "Добро пожаловать в веб-приложение Шторка.<br />Приложение еще не настроено.",
		...
		builder: {
			...
			header:{
				editMe: "Щелкните, чтобы изменить описание",
		...
		swipe: {
			...
			settingsDataModel: {
				settingsTabDataModel: "Слой Шторка",
				...
				settingsDataModel1Explain: "Выберите слой, который будет контролироваться инструментом Шторка.",
