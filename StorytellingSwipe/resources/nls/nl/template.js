	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				invalidConfigNoWebmap: "Ĳ_Fatal error: Invalid configuration (web map or application identifier not specified in index.html)______________________________ä",
				invalidConfigNoAppDev: "Ĳ_No Web Mapping Application identifier or webmap are specified in URL parameters (?appid= or ?webmap=). In development mode, the appid and webmap configuration in index.html are ignored_________________________________________________________ä.",
				...
				initMobile2: "Ĳ_The Swipe builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen_____________________________________________________ä.",
				initMobile3: "Ĳ_Please rotate your device to landscape orientation to use the Swipe builder________________________ä.",
				...
				notAuthorizedBuilder: "Ĳ_You are not authorized to use Swipe and Spyglass builder__________________ä.",
		...
		builder: {
			builder: {
				...
				saveSuccess: "Ĳ_Story saved____ä",
		...
		swipe: {
			...
			settingsLegend: {
				...
				settingsPopupDisable: "Ĳ_Enable pop-up_____ä",
				settingsLocationSearchEnable: "Zoeken naar locaties inschakelen",
				settingsGeolocatorEnable: "Geografische locator inschakelen",
				settingsLegendHelpContent: "Ĳ_To refine the legend content, use the ArcGIS web map viewer table of contents (Hide in Legend)_____________________________ä",
			...
			share: {
				...
				sharePrivateOk: "Ĳ_Sharing updated, loading_________ä...",
				...
				shareLinkHeader: "Ĳ_Share your story______ä",
				...
				shareWarningWith1: "Ĳ_publicly___ä",
				shareWarningWith2: "Ĳ_publicly and with the Organization___________ä"
			},
			directCreation: {
				...
				explain2: "Ĳ_To create a Swipe or Spyglass story map, use the button below to choose the existing web map you want to use. Alternatively, you can paste the ID of the web map into the field below________________________________________________________ä.",
