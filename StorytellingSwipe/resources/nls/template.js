	...
	root: ({
		...
		swipe: {
			...
			share: {
				...
				firstSaveHeader: "Please read the following answers to frequent questions.",
				firstSaveA1: "The story can also be found in your <a href='%LINK2%' target='_blank'>My Content</a>, or you can bookmark the app in your browser. If you are signed in when you view the story you will see a button to Switch to Builder Mode.",
				firstSaveA1bis: "The story can also be found in your <a href='%LINK2%' target='_blank'>content folder</a>.",
				firstSaveQ2: "Is my story shared?",
				firstSaveA2: "Your story is not currently shared with anyone. To share it, use the SHARE button.",
				myStories: "My stories",
				manageStory: "Manage your story",
				manageStoryA1: "Tip: You can use <a href='http://storymaps.arcgis.com/en/my-stories/' target='_blank'>My Stories</a> to check your story for errors and change how its components are shared. My Stories also helps you make your story look good when it is shared on social media sites. You can learn about other useful features of My Stories in these <a href='https://blogs.esri.com/esri/arcgis/tag/my-stories/' target='_blank'> blog posts.</a>",
				...
				shareLinkHeader: "Share the story",
				shareLinkOpen: "OPEN",
				...
				shareA2div2: "As the owner of the story, when you are signed in, the story includes a button to open the interactive builder:",
