	...
	root: ({
		...
		swipe: {
			...
			share: {
				...
				firstSaveHeader: "Your story is now saved",
				...
				manageStoryA1: "You can use <a href='http://storymaps.arcgis.com/en/my-stories/' target='_blank'>My Stories</a> on the Esri Story Maps website to check your story for errors and easily change how it and its components are shared. My Stories also helps you make your story look good when it is shared on social media sites and has other useful features that you can learn about in these <a href='https://blogs.esri.com/esri/arcgis/tag/my-stories/' target='_blank'> blog posts.</a>",
