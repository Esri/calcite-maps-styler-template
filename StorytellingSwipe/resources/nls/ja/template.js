	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				invalidConfigNoWebmap: "須_Fatal error: Invalid configuration (web map or application identifier not specified in index.html)______________________________鷗",
				invalidConfigNoAppDev: "須_No Web Mapping Application identifier or webmap are specified in URL parameters (?appid= or ?webmap=). In development mode, the appid and webmap configuration in index.html are ignored_________________________________________________________鷗.",
				...
				initMobile2: "須_The Swipe builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen_____________________________________________________鷗.",
				initMobile3: "須_Please rotate your device to landscape orientation to use the Swipe builder________________________鷗.",
				...
				notAuthorizedBuilder: "須_You are not authorized to use Swipe and Spyglass builder__________________鷗.",
		...
		builder: {
			builder: {
				...
				saveSuccess: "須_Story saved____鷗",
		...
		swipe: {
			...
			settingsLegend: {
				...
				settingsPopupDisable: "須_Enable pop-up_____鷗",
				settingsLocationSearchEnable: "ロケータ検索の有効化",
				settingsGeolocatorEnable: "ジオロケータの有効化",
				settingsLegendHelpContent: "須_To refine the legend content, use the ArcGIS web map viewer table of contents (Hide in Legend)_____________________________鷗",
			...
			share: {
				firstSaveTitle: "須_Story saved____鷗",
				manageStory: "須_Manage your story______鷗",
				manageStoryA1: "須_Tip: You can use %LINK1% to check your story for errors and change how its components are shared. My Stories also helps you make your story look good when it is shared on social networks. You can learn about other useful features of My Stories in these %LINK2%_______________________________________________________________________________鷗.",
				manageStoryA1V1: "須_My Stories____鷗",
				manageStoryA1V2: "須_blog posts____鷗",
				shareTitle: "ストーリーの共有",
				...
				sharePrivateOk: "須_Sharing updated, loading_________鷗...",
				...
				shareLinkHeader: "須_Share your story______鷗",
				shareLinkOpen: "オープン",
				learnMore: "詳細",
				...
				shareWarningWith1: "須_publicly___鷗",
				shareWarningWith2: "須_publicly and with the Organization___________鷗"
			},
			directCreation: {
				...
				explain2: "須_To create a Swipe or Spyglass story map, use the button below to choose the existing web map you want to use. Alternatively, you can paste the ID of the web map into the field below________________________________________________________鷗.",
