	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				invalidConfigNoWebmap: "כן_Fatal error: Invalid configuration (web map or application identifier not specified in index.html)______________________________ש",
				invalidConfigNoAppDev: "כן_No Web Mapping Application identifier or webmap are specified in URL parameters (?appid= or ?webmap=). In development mode, the appid and webmap configuration in index.html are ignored_________________________________________________________ש.",
				...
				initMobile2: "כן_The Swipe builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen_____________________________________________________ש.",
				initMobile3: "כן_Please rotate your device to landscape orientation to use the Swipe builder________________________ש.",
				...
				notAuthorizedBuilder: "כן_You are not authorized to use Swipe and Spyglass builder__________________ש.",
			...
			desktopView: {
				...
				tooltipAutoplayDisabled: "כן_This isn't available in autoplay mode____________ש",
				autoplayLabel: "כן_Autoplay mode_____ש",
				autoplayExplain1: "כן_Autoplay mode will advance through your story at a regular interval. This is ideal on a kiosk or public display monitor, but be aware that in other situations it may make the story harder to read. This feature isn't supported on small displays__________________________________________________________________________ש.",
				autoplayExplain2: "כן_When this mode is active there are controls to play/pause the story and adjust the navigation speed_______________________________ש."
			}
		},
		builder: {
			builder: {
				...
				saveSuccess: "כן_Story saved____ש",
		...
		swipe: {
			...
			settingsLegend: {
				...
				settingsPopupDisable: "כן_Enable pop-up_____ש",
				settingsLocationSearchEnable: "הפעל חיפוש עיגון כתובות",
				settingsGeolocatorEnable: "הפעל חיפוש מרחבי",
				settingsLegendHelpContent: "כן_To refine the legend content, use the ArcGIS web map viewer table of contents (Hide in Legend)_____________________________ש",
			...
			share: {
				firstSaveTitle: "כן_Story saved____ש",
				manageStory: "כן_Manage your story______ש",
				manageStoryA1: "כן_Tip: You can use %LINK1% to check your story for errors and change how its components are shared. My Stories also helps you make your story look good when it is shared on social networks. You can learn about other useful features of My Stories in these %LINK2%_______________________________________________________________________________ש.",
				manageStoryA1V1: "כן_My Stories____ש",
				manageStoryA1V2: "כן_blog posts____ש",
				...
				sharePrivateOk: "כן_Sharing updated, loading_________ש...",
				...
				shareLinkHeader: "כן_Share your story______ש",
				shareLinkOpen: "פתח",
				learnMore: "מידע נוסף",
				...
				shareWarningWith1: "כן_publicly___ש",
				shareWarningWith2: "כן_publicly and with the Organization___________ש"
			},
			directCreation: {
				...
				explain2: "כן_To create a Swipe or Spyglass story map, use the button below to choose the existing web map you want to use. Alternatively, you can paste the ID of the web map into the field below________________________________________________________ש.",
