	 ...
	 ({
		viewer: {
			loading: {
				...
				loadBuilder: "ĐANG CHUYỂN SANG CHẾ ĐỘ BỘ THIẾT LẬP",				
			...
			desktopView: {
				...
				builderButton: "Chuyển sang chế độ bộ thiết lập",
		...
		swipe: {
			mobileData: {
				...
				noPopup: "Không tìm thấy cửa sổ pop-up cho đối tượng này"
			},
			mobileLegend: {
				noLegend: "Không có chú giải để hiển thị."
			},
			swipeSidePanel: {
				editTooltip: "Thiết lập mô tả bảng điều khiển bên",
				editMe: "Chỉnh sửa tôi!",
			...
			settingsLayout: {
				...
				settingsLayoutSpyGlass: "Kính phóng đại",
			...
			settingsDataModel: {
				...
				settingsDataModelExplainSpyGlass: "Chọn lớp hoặc bản đồ web xuất hiện trong kính phóng đại.",
				...
				settingsDataModel1SpyGlassExplain: "Chọn lớp xuất hiện trong phạm vi kính phóng đại.",
				...
				settingsDataModelWebmapSwipeId1: "ID bản đồ Web bên phải",
				settingsDataModelWebmapSwipeId2: "ID bản đồ Web bên trái",
				settingsDataModelWebmapGlassId1: "ID bản đồ Web chính",
				settingsDataModelWebmapGlassId2: "ID bản đồ Web kính phóng đại",
			...
			settingsLegend: {
				...
				settingsSeriesHelpContent2: "Chuỗi Trượt nhanh cho phép bạn tạo và sửa một loạt các địa điểm cùng với tiêu đề và văn bản. Nếu bản đồ web của bạn có những đánh dấu, chúng sẽ được hiển thị. Bạn có thể tắt thanh chuỗi, nhưng cấu hình chuỗi sẽ được lưu giữ để sử dụng trong tương lai.",
			...
			settingsSwipePopup: {
				...
				settingsSwipePopupSwipe1: "Bản đồ Bên trái",
				settingsSwipePopupSwipe2: "Bản đồ Bên phải",
				settingsSwipePopupGlass1: "Bản đồ chính",
				settingsSwipePopupGlass2: "Bản đồ Kính phóng đại",
				settingsSwipePopupTitle: "Tiêu đề Đầu mục",
				settingsSwipePopupColor: "Màu sắc Đầu mục"
			},
			initPopup: {
				initHeader: "Chào mừng bạn đến với Bộ thiết lập Trượt nhanh/Kính phóng đại",
				modalNext: "Tiếp",
				modalPrev: "Trước",
			...
			helpPopup: {
				...
				close: "Đóng",
				tab1: {
					div1: "Mẫu Trượt nhanh/Kính phóng đại được thiết kế để so sánh hai bản đồ web riêng biệt hoặc hai lớp bản đồ web duy nhất trong một ứng dụng web dễ sử dụng và đầy hấp dẫn có thể được sử dụng trong bất kỳ trình duyệt web nào trên bất kỳ thiết bị nào, bao gồm cả điện thoại thông minh và máy tính bảng.",
					div2: "Để biết thêm thông tin về mẫu Trượt nhanh/Kính phóng đại, bao gồm các mẫu do người dùng tạo, <a href='http://storymaps.arcgis.com/en/app-list/swipe/' target='_blank'> truy cập trang web Story Maps</a>. Bạn cũng có thể theo dõi chúng tôi trên Twitter tại <a href='https://twitter.com/EsriStoryMaps' target='_blank'>@EsriStoryMaps</a>.",
					div3: "Chúng tôi muốn nghe phản hồi từ bạn! Cho dù bạn có một câu hỏi, muốn yêu cầu một tính năng mới hoặc cho rằng bạn đã tìm thấy một lỗi, vui lòng truy cập <a href='http://links.esri.com/storymaps/forum' target='_blank'>Diễn đàn Người dùng Story Maps</a>."
				}
			},
			share: {
				...
				firstSaveA1: "Nếu bạn không quen với ArcGIS Online hoặc muốn có một shortcut để truy cập vào giao diện thực hiện, bạn có thể lưu liên kết sau đây:%LINK1%",
				...
				sharePrivateOk: "Chia sẻ cập nhật thành công, đang tải...",
				...
				shareHeader1: "Có thể truy cập <strong>Ứng dụng một cách công khai</strong>.",
				...
				shareQ2: "Làm cách nào để chỉnh sửa Ứng dụng sau này?",
				shareQ2bis: "Làm cách nào để quay lại giao diện thực hiện?",
				...
				shareWarning: "Chia sẻ %WITH% đã bị vô hiệu hóa vì bạn không phải là chủ sở hữu <a href='%LINK%' target='_blank'>bản đồ web</a>.",
 				shareWarningWith1: "một cách công khai",
 				shareWarningWith2: "công khai và với Tổ chức"
			},
			directCreation: {
				header: "Chào mừng bạn đến với Bộ thiết lập Trượt nhanh/Kính phóng đại",
				...
				explain2: "Để tạo một story map Trượt nhanh hoặc Kính phóng đại, sử dụng nút dưới đây để chọn bản đồ web ArcGIS Online hiện tại mà bạn muốn sử dụng. Ngoài ra, bạn có thể dán các ID của bản đồ web vào trường bên dưới.",
