	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				invalidConfigNoWebmap: "한_Fatal error: Invalid configuration (web map or application identifier not specified in index.html)______________________________빠",
				invalidConfigNoAppDev: "한_No Web Mapping Application identifier or webmap are specified in URL parameters (?appid= or ?webmap=). In development mode, the appid and webmap configuration in index.html are ignored_________________________________________________________빠.",
				...
				initMobile2: "한_The Swipe builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen_____________________________________________________빠.",
				initMobile3: "한_Please rotate your device to landscape orientation to use the Swipe builder________________________빠.",
				...
				notAuthorizedBuilder: "한_You are not authorized to use Swipe and Spyglass builder__________________빠.",
		...
		builder: {
			builder: {
				...
				saveSuccess: "한_Story saved____빠",
		...
		swipe: {
			...
			settingsLegend: {
				...
				settingsPopupDisable: "한_Enable pop-up_____빠",
				settingsLocationSearchEnable: "로케이터 검색 사용",
				settingsGeolocatorEnable: "지오로케이터 사용",
				settingsLegendHelpContent: "한_To refine the legend content, use the ArcGIS web map viewer table of contents (Hide in Legend)_____________________________빠",
			...
			share: {
				firstSaveTitle: "한_Story saved____빠",
				manageStory: "한_Manage your story______빠",
				manageStoryA1: "한_Tip: You can use %LINK1% to check your story for errors and change how its components are shared. My Stories also helps you make your story look good when it is shared on social networks. You can learn about other useful features of My Stories in these %LINK2%_______________________________________________________________________________빠.",
				manageStoryA1V1: "한_My Stories____빠",
				manageStoryA1V2: "한_blog posts____빠",
				shareTitle: "스토리 공유",
				...
				sharePrivateOk: "한_Sharing updated, loading_________빠...",
				...
				shareLinkHeader: "한_Share your story______빠",
				shareLinkOpen: "열기",
				learnMore: "자세한 정보",
				...
				shareWarningWith1: "한_publicly___빠",
				shareWarningWith2: "한_publicly and with the Organization___________빠"
			},
			directCreation: {
				...
				explain2: "한_To create a Swipe or Spyglass story map, use the button below to choose the existing web map you want to use. Alternatively, you can paste the ID of the web map into the field below________________________________________________________빠.",
