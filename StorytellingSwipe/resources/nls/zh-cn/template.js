	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				invalidConfigNoWebmap: "试_Fatal error: Invalid configuration (web map or application identifier not specified in index.html)______________________________验",
				invalidConfigNoAppDev: "试_No Web Mapping Application identifier or webmap are specified in URL parameters (?appid= or ?webmap=). In development mode, the appid and webmap configuration in index.html are ignored_________________________________________________________验.",
				createMap: "无法创建地图",
				invalidApp: "严重错误: 无法加载故事",
				initMobile: "欢迎使用卷帘 web 应用程序。未配置该应用程序。移动设备不支持交互式构建器。",
				initMobile2: "试_The Swipe builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen_____________________________________________________验.",
				initMobile3: "试_Please rotate your device to landscape orientation to use the Swipe builder________________________验.",
				...
				notAuthorizedBuilder: "试_You are not authorized to use Swipe and Spyglass builder__________________验.",
		...
		builder: {
			builder: {
				...
				saveSuccess: "试_Story saved____验",
				saveError: "保存失败，请重试",
		...
		swipe: {
			...
			settingsLegend: {
				...
				settingsPopupDisable: "试_Enable pop-up_____验",
				settingsLocationSearchEnable: "启用定位器搜索",
				settingsGeolocatorEnable: "启用地理定位器",
				settingsLegendHelpContent: "试_To refine the legend content, use the ArcGIS web map viewer table of contents (Hide in Legend)_____________________________验",
			...
			share: {
				firstSaveTitle: "试_Story saved____验",
				manageStory: "试_Manage your story______验",
				manageStoryA1: "试_Tip: You can use %LINK1% to check your story for errors and change how its components are shared. My Stories also helps you make your story look good when it is shared on social networks. You can learn about other useful features of My Stories in these %LINK2%_______________________________________________________________________________验.",
				manageStoryA1V1: "试_My Stories____验",
				manageStoryA1V2: "试_blog posts____验",
				shareTitle: "共享您的故事",
				...
				sharePrivateOk: "试_Sharing updated, loading_________验...",
				shareStatus1: "未保存故事",
				...
				shareLinkHeader: "试_Share your story______验",
				shareLinkOpen: "打开",
				learnMore: "了解详细信息",
				...
				shareWarningWith1: "试_publicly___验",
				shareWarningWith2: "试_publicly and with the Organization___________验"
			},
			directCreation: {
				...
				explain2: "试_To create a Swipe or Spyglass story map, use the button below to choose the existing web map you want to use. Alternatively, you can paste the ID of the web map into the field below________________________________________________________验.",
