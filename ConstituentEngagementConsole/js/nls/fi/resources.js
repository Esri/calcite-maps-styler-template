...
define(
     ({
        ...
        applicationHeader: {
            ...
            signOutOption: "Kirjaudu ulos", // Appears when user has not signed in
        ...
        dataviewer: {
            ...
            layerFeatureCount: "Å_${featureCount} records________ö" // Appears beside operational layer name to display count of feature
        },
        timeSlider: {
