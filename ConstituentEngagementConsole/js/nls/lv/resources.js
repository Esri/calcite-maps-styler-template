...
define(
     ({
        ...
        dataviewer: {
            ...
            layerFeatureCount: "ķ_No of records: ${featureCount}__________ū" // Appears beside operational layer name to display count of feature
        },
        timeSlider: {
        ...
        filter: {
            ...
            dropdownSelectOption: "ķ_Select___ū" // Displayed as a first option in a filter dropdown
        },
        detailsPanel: {
