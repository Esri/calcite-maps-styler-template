...
define([
  ...
  registry, Menu, focus, CheckedMenuItem,
  ...
  return declare(null, {
      ...
      if (config) {
        ...
        ready(lang.hitch(this, function() {
          ...
          if (this.config.splashModal) {
            ...
            dom.byId("closeOverlay").value = this.config.splashButtonText ||
            this.config.i18n.nav.close;
      ...
      toolbar.startup().then(lang.hitch(this, function() {
        ...
        all(toolList).then(lang.hitch(this, function(results) {
          ...
          if (!this.config.activeTool || this.config.activeTool ===
            "") {
            if (toolbar.pTools && toolbar.pTools.children &&
              toolbar.pTools.children.length && toolbar.pTools
                .children.length >
              0) {
              domAttr.set(dom.byId(toolbar.pTools.children[
                0].id), "tabindex", "0");
            /*focus.focus(dom.byId(toolbar.pTools.children[
              0].id));*/
            }
      ...
      require(["application/has-config!print?application/PrintConfig",
        ...
        printConfig.createPrintOptions().then(lang.hitch(this,
          function(results) {
            ...
            domConstruct.place(titleNode, printDiv, "first");
            ...
            domConstruct.place(this.print.printDomNode,
              printDiv, "first");
    ...
    _updateTheme: function() {
      ...
      if (this.config.icons === "black") {
        ...
        query(".LocateButton .zoomLocateButton").style("color",
          "#000");
      }
    },
    ...
    _createWebMap: function(itemInfo, params) {
      ...
      arcgisUtils.createMap(itemInfo, "mapDiv", {
        ...
        // Set the default map desc as the default alt text
        ...
        domAttr.set(this.map.container, "aria-label", this.config
            .altMapText || esriLang.stripTags(response.itemInfo
            .item.description));
