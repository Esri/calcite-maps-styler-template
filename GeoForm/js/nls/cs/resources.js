define(
   ({
    ...
    builder: {
      ...
      shareDescription: "Panel sdílení umožňuje uživatelům jednoduše sdílet formuláře GeoForm s ostatními spolupracovníky poté, co odešlou příspěvek. Tuto možnost lze kdykoliv vypnout.",
    ...
    viewer: {
      ...
      viewReportsTabText: "Odeslané položky",
      ...
      mapTabTooltip: "Mapa",
      appLoadingFailedMessage: "Režim prohlížeče není k dispozici.",
      btnDescendingText: "Sestupně",
      btnAscendingText: "Vzestupně",
      geometryUnavailableErrorMessage: "Nepodařilo se najít geometrii prvku.",
      infoPopupOffErrorMessage: "Informace ve vyskakovacím okně jsou vypnuty.",
