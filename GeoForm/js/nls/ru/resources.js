define(
   ({
    ...
    builder: {
      ...
      layerTabTitleText: "Выбрать редактируемый слой(и)",
      ...
      layerTabText: "Это слой(и), из которого будет строиться GeoForm. Он должен быть сервисом объектов, который доступен для редактирования и с правами доступа для вашей аудитории. При выборе всех полей форма позволит выбрать, какой слой формы отправить.",
