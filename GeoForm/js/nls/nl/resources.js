define({
  root: ({
    ...
    user: {
      ...
      invalidString: "Ĳ_Please enter a valid value_________ä.",
      invalidSmallNumber: "Ĳ_Please enter a valid ${openStrong}integer${closeStrong} value between -32768 and 32767___________________________ä.",
      ...
      requiredFields: "Ĳ_The following field is required. Please provide a valid entry____________________ä.",
      ...
      exceededFileCountError: "Ĳ_Exceeded maximum number of attachments allowed_______________ä",
      selectFileTitle: "Een bestand selecteren",
      btnSelectFileText: "Ĳ_Select File____ä",
      btnViewSubmissions: "Meldingen bekijken"
    },
    builder: {
      gettingStarted: "Ĳ_Getting Started______ä",
      dateSettings: "Ĳ_Date Settings_____ä",
      hiddenDateField: "Ĳ_Hide this date field_______ä",
      preventPastDates: "Ĳ_Prevent past dates______ä",
      preventFutureDates: "Ĳ_Prevent future dates_______ä",
      useCurrentDate: "Ĳ_Set this field with the current date and time_______________ä",
      configure: "Ĳ_Configure____ä",
      configureField: "Ĳ_Configure Field '${fieldName}'__________ä",
      ...
      setViewerText: "Ĳ_Configure Viewer______ä",
      introText: "Ĳ_Start___ä",
      webmapText: "Webmap",
      layerText: "Kaartlaag",
      detailsText: "Details",
      fieldsText: "Velden",
      styleText: "Stijl",
      viewerText: "Ĳ_Viewer___ä",
      optionText: "Opties",
      ...
      layerTabTitleText: "Ĳ_Select Editable Layer(s)________ä",
      ...
      fieldDescriptionHelpText: "Ĳ_Provide a short description or instructions for this field___________________ä.",
      fieldHintHelpText: "Ĳ_Placeholder text for the field__________ä.",
      ...
      layerTabText: "Ĳ_This is the layer(s) that the GeoForm will be built from. The layer must be a feature service that is enabled for editing with sharing permissions appropriate for your audience. If all layers are selected, the form will allow a user to choose which form layer to submit to___________________________________________________________________________________ä.",
      ...
      viewerTabText: "Ĳ_Set options for viewing submissions collected from the GeoForm____________________ä.",
      ...
      shareGeoformText: "Ĳ_Social media sharing buttons_________ä",
      shareDescription: "Ĳ_Social media buttons allow your audience to easily share your GeoForm once they have made a submission________________________________ä",
      ...
      showHideLayerHelpText: "Ĳ_You can configure the GeoForm to Show/Hide Layer. This option only applies to a single layer setup_______________________________ä.",
      ...
      allLayerSelectOptionText: "Ĳ_All Layers____ä",
      disableViewer: "Viewer uitschakelen",
      disableViewerDescription: "Ĳ_You can configure the GeoForm to disable/enable the viewer__________________ä",
    ...
    viewer: {
      ...
      aboutUsTabTooltip: "Ĳ_About Us___ä",
      mapTabTooltip: "Kaart",
      btnDescendingText: "Aflopend",
      btnAscendingText: "Oplopend",
      geometryUnavailableErrorMessage: "Ĳ_Erorr finding the geometry of the feature_____________ä",
      infoPopupOffErrorMessage: "Ĳ_No information to display_________ä",
      btnLoadMoreText: "Meer laden",
      unavailableTitleText: "Naamloos",
      unavailableConfigMessage: "Kan configuratie niet laden",
      share: "Ĳ_Share___ä",
      viewReportsTabText: "Ĳ_Reports___ä",
      viewLegendTabText: "Legenda",
      viewAboutusTabText: "Informatie",
      btnSubmitReportText: "Een rapport indienen",
      appLoadingFailedMessage: "Ĳ_There was an error loading the viewer____________ä"
    }
  }),
  "ar": 1,
  "cs": 1,
