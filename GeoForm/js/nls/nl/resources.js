     ...
     ({
        ...
        configure: {
            ...
            sharedlg: {
                ...
                mailtoLinkDescription: "Hier is een link naar een GeoForm"
            }
        },
        user: {
            mgrs: "MGRS",
            ...
            locationDescriptionForMoreThanOneOption: "Geef de locatie voor deze vermelding op door op de kaart te klikken/tikken of door een van de volgende opties te gebruiken.",
            ...
            locationDescriptionForNoOption: "Geef de locatie voor deze invoer op door op de kaart te klikken/tikken.",
            addressText: "Zoeken",
            ...
            selectLocation: "Selecteer een locatie voor uw voor uw verzending.",
            ...
            invalidNumber: "Geef een geldige ${openStrong}integer${closeStrong} waarde op tussen -2147483648 en 2147483647.",
            invalidFloat: "Geef een geldige ${openStrong}zwevende punt${closeStrong} waarde op.",
            invalidDouble: "Geef een geldige ${openStrong}dubbele${closeStrong} waarde op.",
        ...
        builder: {
            ...
            webmapDetailsText: "De geselecteerde webmap is ${webMapTitleLink}${webMapTitle}${closeLink}. Klik om een andere webmap te selecteren op de knop 'Webmap kiezen'",
            ...
            showHideLayerHelpText:"U kunt de GeoForm configureren om de laag te tonen/verbergen"
        }
    })
);