define(
   ({
    ...
    builder: {
      ...
      geoformTitleText: "GeoForm",
      layerTabText: "Dette er laget som GeoForm blir bygd fra. Laget må være en geoobjekttjeneste som er aktivert for redigering, med deletillatelser som egner seg for målgruppen. Hvis alle lag er valgt, kan skjemaet brukes til å velge hvilket skjemalag som skal sendes til.",
