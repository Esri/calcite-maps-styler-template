define(
     ({
        ...
        user: {
            ...
            invalidFloat: "Introduce un valor de ${openStrong}coma flotante${closeStrong} válido.",
        ...
        builder: {
            ...
            attachmentLabelHint: "Este es el texto que aparecerá al lado del botón Adjunto. Puedes usar este espacio para describir lo que deseas que adjunte tu audiencia (fotos, vídeos, documentos, etc.), el tipo de formato que solicitas (.jpeg, .png, .docx, .pdf, etc.) y cualquier instrucción adicional",
