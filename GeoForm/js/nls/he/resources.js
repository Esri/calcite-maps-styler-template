define(
     ({
        ...
        user: {
            ...
            invalidDouble: "אנא הזן ערך חוקי של ${openStrong}כפול${closeStrong}.",
        ...
        builder: {
            ...
            jumbotronDescription: "השתמש בכותרת עליונה קטנה או גדולה עבור הטופס. כותרת עליונה גדולה יכולה לעזור בהגדרת מטרת האפליקציה, אך היא תופסת מקום רב יותר על המסך.",
            ...
            dragTooltipText:"גרור את השדה למקום שבו ברצונך שהוא יופיע",
