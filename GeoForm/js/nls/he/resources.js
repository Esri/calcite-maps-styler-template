define(
   ({
    ...
    user: {
      ...
      invalidSmallNumber: "הזן ערך חוקי שהוא ${openStrong}מספר שלם${closeStrong} בין 32768 ל-‏32767.",
      ...
      requiredFields: "השדה הבא הוא שדה חובה. ציין ערך חוקי.",
      requiredField: "(נדרש)",
      error: "שגיאה",
    ...
    builder: {
      ...
      dateSettings: "הגדרות תאריך",
      hiddenDateField: "הסתר שדה תאריך זה",
      preventPastDates: "מנע תאריכים מהעבר",
      preventFutureDates: "מנע תאריכים מהעתיד",
      useCurrentDate: "הגדר בשדה זה את התאריך והשעה הנוכחיים",
      configure: "קבע תצורה",
      ...
      enableBasemapToggle: "הצג אפשרויות מפת בסיס",
      enableBasemapToggleDescription: "אתה יכול להגדיר את ה-GeoForm להציג/להסתיר את אפשרויות מפת הבסיס",
      ...
      fieldDescriptionHelpText: "ציין תיאור קצר או הנחיות לשדה זה.",
      fieldHintHelpText: "טקסט ממלא מקום עבור השדה.",
      ...
      layerTabText: "אלו השכבות שמהן ייבנה ה-GeoForm‏. השכבה חייבת להיות שירות ישויות ניתן לעריכה עם הרשאות שיתוף מתאימות לקהל שלך. במקרה שכל השכבות נבחרות, הטופס יאפשר למשתמש לבחור את שכבת הטופס שתהיה יעד השליחה.",
      ...
      viewerTabText: "הגדר אפשרויות להצגת פריטים שנשלחו, אשר נאספו מתוך GeoForm‏.",
      ...
      allLayerSelectOptionText: "כל השכבות",
      disableViewer: "השבת צפיין",
      disableViewerDescription: "אתה יכול להגדיר את ה-GeoForm להשבית/להפעיל את חלון התצוגה",
      displayFieldHintText: "שדה התצוגה שנבחר יופיע בחלון התצוגה ככותרת"
    },
    viewer: {
