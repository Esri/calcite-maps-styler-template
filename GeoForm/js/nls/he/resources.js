define(
     ({
        ...
        builder: {
            ...
            invalidWebmapSelectionAlert: "מפת האינטרנט שנבחרה לא מכילה שכבה חוקית שניתן להשתמש בה. הוסף למפת האינטרנט FeatureLayer שניתן לערוך כדי שתוכל להמשיך.",
            ...
            detailsTabText: "השתמש בתיבות פרטי טופס למטה כדי להתאים את הכותרת, להוסיף לוגו מותאם ולספק תיאור קצר לקהל של ה-GeoForm שלך. בתיאור ניתן להוסיף קישורים למשאבים אחרים, פרטי קשר ואפילו להפנות את הקהל שלך אל אפליקציית מיפוי אינטרנט הכוללת את כל הנתונים שנאספו עם ה-GeoForm.",
            ...
            defaultMapExtentDescription: "המפה תתאפס לתיחום ברירת המחדל במפת האינטרנט שלך לאחר השליחה - ניתן לבטל אפשרות זו בכל עת.",
            pushpinOptionsDescription: "בחר מבין מגוון צבעים לנעץ על המפה, עליו להיות שונה מהסימבולוגיה של המפה כדי לסייע למשתמש להראות את המידע שלו על-גבי המפה",
