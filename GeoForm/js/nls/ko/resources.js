define(
   ({
    ...
    user: {
      ...
      invalidString: "유효한 값을 입력하세요.",
      invalidSmallNumber: "-32768~32767의 유효한 ${openStrong}정수${closeStrong} 값을 입력하세요.",
      ...
      requiredFields: "다음은 필수 필드입니다. 유효한 항목을 입력하세요.",
      requiredField: "(필수)",
      error: "오류",
      ...
      exceededFileCountError: "허용된 첨부 파일 최대 개수 초과",
      selectFileTitle: "파일 선택",
      btnSelectFileText: "파일 선택",
      btnViewSubmissions: "제출 내역 보기"
    },
    builder: {
      gettingStarted: "시작하기",
      dateSettings: "날짜 설정",
      hiddenDateField: "이 날짜 필드 숨기기",
      preventPastDates: "이전 날짜 금지",
      preventFutureDates: "이후 날짜 금지",
      useCurrentDate: "현재 날짜와 시간으로 이 필드 설정",
      configure: "구성",
      configureField: "\'${fieldName}\' 필드 구성",
      ...
      enableBasemapToggle: "베이스맵 전환 보기",
      enableBasemapToggleDescription: "GeoForm을 베이스맵 전환 보기/숨기기로 구성할 수 있습니다.",
      ...
      fieldDescriptionHelpText: "이 필드에 대한 간단한 설명이나 지침을 제공합니다.",
      fieldHintHelpText: "필드에 대한 플레이스 홀더 텍스트입니다.",
      ...
      geoformTitleText: "GeoForm",
      layerTabText: "이 레이어로부터 GeoForm이 구축됩니다. 이 레이어는 대상 그룹에 적합한 공유 권한으로 편집할 수 있도록 설정된 피처 서비스여야 합니다. 모든 레이어가 선택된 경우 양식에서 사용자가 제출할 양식 레이어를 선택할 수 있습니다.",
      ...
      viewerTabText: "GeoForm에서 수집한 제출 내역 보기 옵션을 설정합니다.",
      ...
      shareGeoformText: "소셜 미디어 공유 버튼",
      shareDescription: "소셜 미디어 버튼을 통해 대상 그룹은 제출 완료 후 GeoForm을 쉽게 공유할 수 있습니다.",
      ...
      allLayerSelectOptionText: "모든 레이어",
      disableViewer: "뷰어 비활성화",
      disableViewerDescription: "GeoForm을 뷰어 활성화/비활성화로 구성할 수 있습니다.",
      displayFieldHintText: "선택한 보기 필드는 뷰어에서 제목으로 보여집니다."
    },
    viewer: {
      ...
      legendTabTooltip: "범례",
      aboutUsTabTooltip: "회사 소개",
      mapTabTooltip: "맵",
      btnDescendingText: "내림차순",
      btnAscendingText: "오름차순",
      geometryUnavailableErrorMessage: "한_Error finding the geometry of the feature_____________빠",
      ...
      share: "공유",
      viewReportsTabText: "보고서",
      viewLegendTabText: "범례",
      viewAboutusTabText: "정보",
      btnSubmitReportText: "보고서 제출",
      appLoadingFailedMessage: "뷰어를 불러오는 중 오류가 발생했습니다."
    }
  })
);