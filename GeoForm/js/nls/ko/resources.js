define(
     ({
        ...
        builder: {
            ...
            attachmentLabelHint: "한_This is the text that will appear next to the Attachment Button. You can use this space to describe what you would like your audience to attach (photo, video, document, etc.), the file format you are asking for (.jpeg, .png, .docx, .pdf, etc.), and any additional instructions_빠",
            ...
            showHideLayerText:"한_Show/Hide Layer_빠",
            showHideLayerHelpText:"한_You can configure the GeoForm to Show/Hide Layer_빠"
        }
    })
);