define(
   ({
    ...
    user: {
      ...
      requiredFields: "약간의 오류가 발생했습니다. 아래에서 오류를 수정하세요.",
      requiredField: "(필수)",
      error: "오류",
    ...
    builder: {
      ...
      geoformTitleText: "GeoForm",
      layerTabText: "이 레이어로부터 GeoForm이 구축됩니다. 이 레이어는 사용자에 적합한 공유 권한으로 편집할 수 있도록 설정된 피처 서비스여야 합니다.",
      ...
      shareDescription: "GeoForm을 제출하고 나면 사용자는 공유 패널을 사용하여 공동 작업자와 쉽게 공유할 수 있습니다. 이 설정은 언제든지 비활성화할 수 있습니다.",
      ...
      showHideLayerHelpText: "GeoForm을 레이어 보기/숨김으로 구성할 수 있습니다. 이 옵션은 단일 레이어 설정에만 적용됩니다.",
    ...
    viewer: {
      ...
      legendTabTooltip: "범례",
      aboutUsTabTooltip: "소개",
      mapTabTooltip: "맵",
      appLoadingFailedMessage: "ViewerMode를 사용할 수 없음",
      btnDescendingText: "내림차순",
      btnAscendingText: "오름차순",
      geometryUnavailableErrorMessage: "피처의 지오메트리를 찾을 수 없음",
      infoPopupOffErrorMessage: "InfoPopup이 꺼짐",
