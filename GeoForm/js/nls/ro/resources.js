define(
     ({
        ...
        user: {
            ...
            locationDescriptionForOneOption: "Specificaţi locaţia acestei intrări făcând clic pe / atingând harta sau utilizând una următoarea opţiune.",
        ...
        builder: {
            ...
            webmapDetailsText: "Harta web selectată este ${webMapTitleLink}${webMapTitle}${closeLink}. Pentru a selecta o hartă web diferită faceţi clic pe butonul \„Alegere hartă web\”",
            ...
            fieldDescriptionLabelText: "Text de ajutor (opţional)",
            ...
            headerSizeLabel:"Dimensiune antet",
            ...
            enableAttachmentLabelHint: "De aici puteţi activa/dezactiva ataşările",
            attachmentIsRequiredLabelText: "${openStrong}Ataşare necesară${closeStrong}",
            attachmentIsRequiredLabelHint: "Dacă este necesar, utilizatorilor li se poate solicita să introducă o ataşare.",
            attachmentLabelText: "Etichetă buton ataşare",
            attachmentLabelHint: "Acesta este textul care va apărea în dreptul butonului de ataşare. Puteţi utiliza acest spaţiu pentru a descrie ce aţi dori să ataşeze publicul (fotografii, clipuri video, documente etc.), formatul pe care îl cereţi (.jpeg, .png, .docx, .pdf etc.) şi eventualele instrucţiuni suplimentare",
            ...
            jumbotronDescription: "Utilizaţi un antet mare sau mic pentru formularul dvs. Un antet mare vă poate ajuta să definiţi scopul aplicaţiei, dar ocupă mai mult spaţiu pe ecran",
