define({
  root: ({
    ...
    user: {
      ...
      invalidString: "ø_Please enter a valid value_________å.",
      invalidSmallNumber: "ø_Please enter a valid ${openStrong}integer${closeStrong} value between -32768 and 32767___________________________å.",
      ...
      requiredFields: "ø_The following field is required. Please provide a valid entry____________________å.",
      ...
      exceededFileCountError: "ø_Exceeded maximum number of attachments allowed_______________å",
      selectFileTitle: "Vælg en fil",
      btnSelectFileText: "ø_Select File____å",
      btnViewSubmissions: "Vis afsendelser"
    },
    builder: {
      gettingStarted: "ø_Getting Started______å",
      dateSettings: "ø_Date Settings_____å",
      hiddenDateField: "ø_Hide this date field_______å",
      preventPastDates: "ø_Prevent past dates______å",
      preventFutureDates: "ø_Prevent future dates_______å",
      useCurrentDate: "ø_Set this field with the current date and time_______________å",
      configure: "ø_Configure____å",
      configureField: "ø_Configure Field '${fieldName}'__________å",
      ...
      setViewerText: "ø_Configure Viewer______å",
      introText: "ø_Start___å",
      webmapText: "Webkort",
      layerText: "Lag",
      detailsText: "Oplysninger",
      fieldsText: "Felter",
      styleText: "Typografi",
      viewerText: "ø_Viewer___å",
      ...
      layerTabTitleText: "ø_Select Editable Layer(s)________å",
      selectLayerLabelText: "Lag",
      selectLayerDefaultOptionText: "Vælg lag",
      enableBasemapToggle: "ø_Show Basemap Toggle_______å",
      enableBasemapToggleDescription: "ø_You can configure the GeoForm to Show/Hide the Basemap Toggle___________________å",
      ...
      fieldDescriptionHelpText: "ø_Provide a short description or instructions for this field___________________å.",
      fieldHintHelpText: "ø_Placeholder text for the field__________å.",
      ...
      layerTabText: "ø_This is the layer(s) that the GeoForm will be built from. The layer must be a feature service that is enabled for editing with sharing permissions appropriate for your audience. If all layers are selected, the form will allow a user to choose which form layer to submit to___________________________________________________________________________________å.",
      ...
      viewerTabText: "ø_Set options for viewing submissions collected from the GeoForm____________________å.",
      ...
      shareGeoformText: "ø_Social media sharing buttons_________å",
      shareDescription: "ø_Social media buttons allow your audience to easily share your GeoForm once they have made a submission________________________________å",
      ...
      showHideLayerHelpText: "ø_You can configure the GeoForm to Show/Hide Layer. This option only applies to a single layer setup_______________________________å.",
      ...
      allLayerSelectOptionText: "ø_All Layers____å",
      disableViewer: "Deaktivér visningsprogram",
      disableViewerDescription: "ø_You can configure the GeoForm to disable/enable the viewer__________________å",
      displayFieldHintText: "ø_Selected display field will be shown in the viewer as a title___________________å"
    },
    viewer: {
      ...
      aboutUsTabTooltip: "ø_About Us___å",
      mapTabTooltip: "Kort",
      btnDescendingText: "Faldende",
      btnAscendingText: "Stigende",
      geometryUnavailableErrorMessage: "ø_Erorr finding the geometry of the feature_____________å",
      infoPopupOffErrorMessage: "ø_No information to display_________å",
      ...
      share: "ø_Share___å",
      viewReportsTabText: "ø_Reports___å",
      viewLegendTabText: "Signaturforklaring",
      viewAboutusTabText: "Om",
      btnSubmitReportText: "Send en rapport",
      appLoadingFailedMessage: "ø_There was an error loading the viewer____________å"
    }
  }),
  "ar": 1,
  "cs": 1,
