define(
   ({
    ...
    user: {
      ...
      requiredFields: "Følgende felt er påkrævet. Angiv en gyldig indtastning.",
      ...
      exceededFileCountError: "Har overskredet det maksimale antal tilladte vedhæftninger",
      selectFileTitle: "Vælg en fil",
      btnSelectFileText: "Vælg fil",
      btnViewSubmissions: "Vis afsendelser"
    },
    builder: {
      gettingStarted: "Getting Started",
      dateSettings: "Datoindstillinger",
      hiddenDateField: "Skjul dette datofelt",
      preventPastDates: "Undgå tidligere datoer",
      preventFutureDates: "Undgå fremtidige datoer",
      useCurrentDate: "Angiv aktuel dato og tidspunkt i dette felt",
      configure: "Configure",
      configureField: "Konfigurér felt \'${fieldName}\'",
      ...
      setViewerText: "Konfigurér visningsprogram",
      introText: "Start",
      webmapText: "Webkort",
      layerText: "Lag",
      ...
      enableBasemapToggle: "Vis Skift baggrundskort",
      enableBasemapToggleDescription: "Du kan konfigurere GeoForm til Vis/Skjul Skift baggrundskort",
      ...
      fieldDescriptionHelpText: "Angiv en kort beskrivelse eller instruktioner til dette felt.",
      fieldHintHelpText: "Pladsholder-tekst til dette felt.",
      ...
      layerTabText: "GeoForm vil blive oprettet ud fra dette/disse lag. Laget skal være en featuretjeneste, der er aktiveret for redigering med de delingsrettigheder, der er relevante for dit publikum. Hvis alle lag er markeret, vil formularen give brugeren mulighed for at vælge, hvilket formularlag, der skal indsendes til.",
      ...
      viewerTabText: "Angiv indstillinger for visning af afsendelser indsamlet fra GeoForm.",
      ...
      shareGeoformText: "Knapper for deling på sociale medier",
      shareDescription: "Med knapper for sociale medier kan dit publikum nemt dele din GeoForm, når de har oprettet en afsendelse",
      ...
      disableViewerDescription: "Du kan konfigurere GeoForm til at deaktivere/aktivere visningsprogrammet",
      displayFieldHintText: "Det valgte visningsfelt vil blive vist i visningsprogrammet som en titel"
    },
    viewer: {
      ...
      aboutUsTabTooltip: "Om Os",
      mapTabTooltip: "Kort",
      btnDescendingText: "Faldende",
      btnAscendingText: "Stigende",
      geometryUnavailableErrorMessage: "Fejl under søgning efter objektets geometri",
      ...
      appLoadingFailedMessage: "Der opstod en fejl under indlæsning af visningsprogrammet"
    }
  })
);