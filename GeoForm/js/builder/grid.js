define([
  ...
  "dgrid/Grid",
  "application/builder/RefreshMixin",
  "dgrid/Selection",
  ...
  function (declare, Evented, dojoString, lang, array, WidgetBase, TemplatedMixin, WidgetsInTemplateMixin, Grid, RefreshMixin,
    ...
    return declare([WidgetBase, Evented], {
      ...
      buildRendering: function () {
        ...
        this._store = this.store || new Cache(new PortalItemStore({
          'portal': this.portal,
      ...
      _setItemsAttr: function (items) {
        this._store = this._store || new Observable(Memory({
          "data": items
        }));
        ...
        if (this._store && this._store.setData) {
          ...
          this._store = new Observable(Memory({
            "data": items
          }));
        }
