...
define(
    ({
        ...
        messages: {
            ...
            searchLayerNotSearchable: "맵 레이어의 필드를 찾을 수 없습니다.<br><br>이 레이어가 맵 컨텐츠의 루트에 있는지 확인하세요. ArcGIS for Server 동적 맵 서비스 등의 중첩된 서비스는 한 번에 한 레이어가 인덱스 번호를 포함해 맵에 추가되어 찾기 레이어로 사용됩니다. 타일 서비스는 찾기 레이어로 사용할 수 없습니다.",
