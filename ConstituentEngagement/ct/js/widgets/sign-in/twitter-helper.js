        ...
        */
        getTwitterLoginResponse: function (url) {
            ...
            esriRequest({
                ...
                this.TWLoggedIn = !("signedIn" in response);
                if (this.TWLoggedIn) {
                    this.userDetails = { fullName: response.name, firstName: null, lastName: null, uniqueID: response.id_str, emailID: null, socialMediaType: "Twitter" };
