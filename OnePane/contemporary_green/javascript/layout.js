  ...
  var i18n; 
   function initMap() {
  	  ...
  	  dojo.byId('descriptionHeader').innerHTML = i18n.viewer.sidePanel.label;
    ...
    function addScalebar(){
      //add contemporary green theme for popup
      dojo.addClass(map.infoWindow.domNode, "contemporary_green");
