	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblLocation: "ตำแหน่ง",
				lblContent: "เนื้อหา",
				lblPopup: "ก้_Pop-up___ษฺ",
				lblControls: "พิเศษ",
				lblOverview: "ภาพรวมของแผนที่",
				lblLegend: "สัญลักษณ์",
				lblGeocoder: "ก้_Address or Place Finder________ษฺ",
				tooltipGeocoder: "ก้_Allow your users to find addresses and places on your maps___________________ษฺ.",
				...
				tooltipPopup: "ก้_Choose a pop-up that will be opened when this map is displayed____________________ษฺ.",
			...
			configure: {
				...
				popupTitle: "ก้_Map pop-up____ษฺ",
				popupExplain: "ก้_Click on a feature to open the pop-up you want to display__________________ษฺ.",
				popupSave: "ก้_Save the pop-up configuration__________ษฺ",
