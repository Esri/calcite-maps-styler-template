	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblLocation: "Locaţie",
				lblContent: "Conţinut",
				lblPopup: "Ă_Pop-up___ș",
				lblControls: "Elemente suplimentare",
				lblOverview: "Hartă de prezentare generală",
				lblLegend: "Legendă",
				lblGeocoder: "Ă_Address or Place Finder________ș",
				tooltipGeocoder: "Ă_Allow your users to find addresses and places on your maps___________________ș.",
				...
				tooltipPopup: "Ă_Choose a pop-up that will be opened when this map is displayed____________________ș.",
			...
			configure: {
				...
				popupTitle: "Ă_Map pop-up____ș",
				popupExplain: "Ă_Click on a feature to open the pop-up you want to display__________________ș.",
				popupSave: "Ă_Save the pop-up configuration__________ș",
