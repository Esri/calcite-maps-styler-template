	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblLocation: "الموقع",
				lblContent: "المحتوى",
				lblPopup: "بيت_Pop-up___لاحقة",
				lblControls: "التطبيقات الإضافية",
				lblOverview: "خريطة النظرة العامة",
				lblLegend: "مفتاح الخريطة",
				lblGeocoder: "بيت_Address or Place Finder________لاحقة",
				tooltipGeocoder: "بيت_Allow your users to find addresses and places on your maps___________________لاحقة.",
				...
				tooltipPopup: "بيت_Choose a pop-up that will be opened when this map is displayed____________________لاحقة.",
			...
			configure: {
				...
				popupTitle: "بيت_Map pop-up____لاحقة",
				popupExplain: "بيت_Click on a feature to open the pop-up you want to display__________________لاحقة.",
				popupSave: "بيت_Save the pop-up configuration__________لاحقة",
