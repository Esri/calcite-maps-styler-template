	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblLocation: "Vieta",
				lblContent: "Turinys",
				lblPopup: "Į_Pop-up___š",
				lblControls: "Priedai",
				lblOverview: "Apžvalga",
				lblLegend: "Legenda",
				lblGeocoder: "Į_Address or Place Finder________š",
				tooltipGeocoder: "Į_Allow your users to find addresses and places on your maps___________________š.",
				...
				tooltipPopup: "Į_Choose a pop-up that will be opened when this map is displayed____________________š.",
			...
			configure: {
				...
				popupTitle: "Į_Map pop-up____š",
				popupExplain: "Į_Click on a feature to open the pop-up you want to display__________________š.",
				popupSave: "Į_Save the pop-up configuration__________š",
