	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblPopup: "á_Pop-up___Ó",
				lblControls: "Extras",
				lblOverview: "Mapa de vista general",
				lblLegend: "Leyenda",
				lblGeocoder: "á_Address or Place Finder________Ó",
				tooltipGeocoder: "á_Allow your users to find addresses and places on your maps___________________Ó.",
				...
				tooltipPopup: "á_Choose a pop-up that will be opened when this map is displayed____________________Ó.",
			...
			configure: {
				...
				popupTitle: "á_Map pop-up____Ó",
				popupExplain: "á_Click on a feature to open the pop-up you want to display__________________Ó.",
				popupSave: "á_Save the pop-up configuration__________Ó",
