	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				customCfg: "自定义配置",
				tooltipLocation: "定义读者导航到此节时所用的地图位置。",
				...
				tooltipLegend: "试_Display the map legend on the map, helpful when the map has many layers and symbols._验",
			...
			configure: {
				...
				extentSave: "保存地图位置",
				popupTitle: "地图弹出窗口",
				popupExplain: "试_Configure the look of the pop-up shown to readers_验",
				popupSave: "保存弹出窗口配置",
