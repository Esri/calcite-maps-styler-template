	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblContent: "Inhalt",
				lblPopup: "ä_Pop-up___Ü",
				lblControls: "Extras",
				lblOverview: "Übersichtskarte",
				lblLegend: "Legende",
				lblGeocoder: "ä_Address or Place Finder________Ü",
				tooltipGeocoder: "ä_Allow your users to find addresses and places on your maps___________________Ü.",
				...
				tooltipPopup: "ä_Choose a pop-up that will be opened when this map is displayed____________________Ü.",
			...
			configure: {
				...
				popupTitle: "ä_Map pop-up____Ü",
				popupExplain: "ä_Click on a feature to open the pop-up you want to display__________________Ü.",
				popupSave: "ä_Save the pop-up configuration__________Ü",
