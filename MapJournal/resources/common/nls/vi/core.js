	 ...
	 ({
		commonCore: {
			...
			share: {
				...
				firstSaveA1: "Nếu bạn không quen với %PORTAL% hoặc muốn có một shortcut để truy cập vào giao diện bộ thiết lập, bạn có thể lưu liên kết sau đây: %LINK1%",
				...
				sharePrivateWarningWith1: "một cách công khai",
				...
				shareHeader1: "Có thể truy cập <strong>ứng dụng của bạn một cách công khai</strong>.",
				...
				shareQ2bis: "Làm cách nào để quay lại giao diện bộ thiết lập?",
				shareA2div1: "Lưu và sử dụng lại liên kết sau %LINK1% hoặc sử dụng <a href='%LINK2%' target='_blank'>trang mục ứng dụng</a>.",
				shareA2div2: "Là chủ sở hữu của ứng dụng, khi bạn đăng nhập vào %PORTAL%, ứng dụng bao gồm một nút mở ra bộ thiết lập:",				
