	 ...
	 ({
		viewer: {
			...
			loading: {
				...
				long: "Εκτελείται προετοιμασία του χαρτογραφικού ημερολογίου",
			...
			errors: {
				...
				invalidConfigNoApp: "Το αναγνωριστικό της εφαρμογής χαρτογράφησης web δεν καθορίζεται στο index.html.",
			...
			shareFromCommon: {
				...
				embedExplain: "Χρησιμοποιήστε τον παρακάτω κώδικα HTML για να ενσωματώσετε το ημερολόγιο σε μια ιστοσελίδα.",
