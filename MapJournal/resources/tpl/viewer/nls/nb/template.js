	 ...
	 ({
		viewer: {
			...
			loading: {
				...
				failButton: "å_Reload the story______ø"
			},
			signin: {
				title: "Krever godkjenning",
				explainViewer: "å_Please sign in with an account on %PORTAL_LINK% to access the story_____________________ø.",
				explainBuilder: "å_Please sign in with an account on %PORTAL_LINK% to configure the story______________________ø."
			},
			errors: {
				...
				notConfiguredDesktop: "å_The story is not configured yet___________ø.",
				notConfiguredMobile: "å_The %TPL_NAME% builder is not supported at this display size___________________ø.",
				...
				noViewerIE: "å_This story is not supported in Internet Explorer before version %VERSION%. %UPGRADE%__________________________ø",
			...
			headerFromCommon: {
				...
				share: "Del",
				checking: "å_Checking your story content_________ø",
				fix: "å_Fix issues in your story________ø",
				noerrors: "å_No issues detected______ø"
			},
			overviewFromCommon: {
				title: "Oversiktskart"
			},
