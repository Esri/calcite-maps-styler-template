define({
  "viewer": {
    ...
    "shareFromCommon": {
      ...
      "print": "Å_Print___ö",
      "printInstruction1": "Å_Please wait for all the content to load before ${printing} this page______________________ö.",
      ...
      "printing": "Å_printing___ö",
      "printWarning": "Å_This is a printed version of a story map. Dynamic content such as videos and interactive maps is only available in the online version at ${link}_____________________________________________ö.",
