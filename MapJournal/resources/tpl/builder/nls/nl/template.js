	 ...
	 ({
		builder: {
			...
			addEditPopup: {
				...
				step: "Stap",
				stepMainStageExplain: "Inhoud hoofdstadium",
				stepPanelExplain: "Inhoud",
			...
			exportData: {
				...
				tooltip: "Door uw inhoud te exporteren kunt u een back-up van uw Journal maken en bekijken als u deze per ongeluk verwijdert. Kopieer en plak de inhoud van de pagina gewoon in een tekstverwerker."
			},
			help: {
				lblHelp: "Help",
			...
			landing: {
				lblAdd: "Hoe wilt u uw Map Journal noemen?",
