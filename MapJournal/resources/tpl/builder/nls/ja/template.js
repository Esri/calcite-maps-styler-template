	 ...
	 ({
		builder: {
			...
			exportData: {
				...
				tooltip: "須_Use this button to export your content locally. This will open a new page that you can easily copy or save as a PDF.<br />Copying that page content in a word processor is the most effective way to recreate your Journal in case of an accidental deletion._鷗"
			},
			help: {
				lblHelp: "ヘルプ",
				lblAdd: "セクションの追加",
