	 ...
	 ({
		builder: {
			...
			help: {
				...
				content5Div1: "בעת שמירת %TPL_NAME%, הוא פרטי בהתחלה. השתמש בלחצן \'שתף\' כדי לשתף אותו עם אחרים. תוכל לשתף את %TPL_NAME% באופן ציבורי, כדי שכל אחד יוכל לגשת אליו.",
				content5Div2: "בהתאם לחשבון שלך, ייתכן שתהיה לך גם אפשרות לשתף את %TPL_NAME% רק לאנשים בארגון שלך, כדי שאנשים אחרים לא יוכלו לגשת אליו.",
