	 ...
	 ({
		builder: {
			...
			help: {
				...
				content2Div2: "Możesz również zmienić logo Esri na swoje własne logo odzwierciedlające markę. Możesz też określić witrynę internetową, która zostanie uruchomiona, jeśli czytelnicy klikną Twoje logo, aby uzyskać więcej informacji.",
				...
				content5Div1: "Po zapisaniu aplikacja %TPL_NAME% pozostaje aplikacją prywatną. Aby udostępnić ją innym, należy kliknąć przycisk Udostępnij. Jeśli upublicznisz aplikację %TPL_NAME%, każdy będzie mógł mieć do niej dostęp.",
