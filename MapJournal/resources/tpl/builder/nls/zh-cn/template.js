define({
  "builder": {
    ...
    "settingsLayoutOptions": {
      ...
      "socialWarning": "试_Your story is using Side Panel layout, but we now recommend using this option only with Floating Panel layout to avoid an issue where the panel may not position itself to the desired section for narratives with images. You may continue to use this option, but if you disable it, it will then only be available when using Floating Panel layout________________________________________________________________________________________________________验."
    },
    "settingsLayoutFonts": {
      "title": "字体",
      "defaultLbl": "默认",
    ...
    "addEditPopup": {
      ...
      "stepPanelExplain": "内容",
      "stepMainStageNextTooltip": "输入节标题并选择主舞台内容",
    ...
    "help": {
      ...
      "content1Div2": "添加节可以使您真正自定义提供信息的经验。在读者滚动 %LAYOUT_TITLE% 文本时，主舞台上的地图可平移或缩放至关键点或新地图，图像也可以自动切换以支持消息。",
