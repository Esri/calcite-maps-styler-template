	...
	root: ({
		builder: {
			...
			settingsLayoutOptions: {
				...
				socialWarning: "Your story is using the Side Panel layout and we now recommend to only enable that option with Floating Panel layout. This prevent issues where the panel may not scroll to the desired section for narratives that contains images. You can continue to use that option but if you disable it, it will only be available with Floating Panel layout."
			},
			settingsLayoutFonts: {
				title: "Fonts",
				defaultLbl: "Default",
