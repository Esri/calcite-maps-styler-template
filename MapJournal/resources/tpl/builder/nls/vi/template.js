	 ...
	 ({
		builder: {
			...
			settingsLayoutOptions: {
				...
				socialLinksDescr: "Đ_This enables readers to reference and promote specific sections of your %TPL_NAME%. For instance, if you use a sections share icon, readers will land at that specific %TPL_NAME% section rather than the beginning of your story. Your readers can use the social media link in the title section to promote your entire %TPL_NAME% (header tab) and have them land at the start of the %TPL_NAME%_ớ."
			},
			settingsLayoutFonts: {
				title: "Đ_Fonts_ớ",
				defaultLbl: "Đ_Default_ớ",
				sectionTitleLbl: "Đ_Section title_ớ",
				sectionContentLbl: "Đ_Section content_ớ"
			},
			initPopup: {
			...
			addEditPopup: {
				...
				stepMainStageNextTooltip2: "Đ_Select the Main Stage content_ớ",
			...
			addEditViewText: {
				...
				mainStageDisabled: "Đ_Main Stage Actions are disabled when the editor is maximized_ớ"
			},
			organizePopup: {
				title: "Tổ chức",
				...
				exportMainStage: "Đ_Main Stage content_ớ",
				exportPanel: "Đ_Panel content_ớ",
				exportActions: "Đ_Main Stage actions_ớ"
			},
			exportData: {
				btn: "Xuất nội dung",
				tooltip: "Đ_Exporting your content allows you to view and create a back-up of your content should you accidentally delete it. Simply copy and paste the content from the page into any word processor_ớ."
			},
			help: {
				lblHelp: "Trợ giúp",
				lblAdd: "Thêm Phần",
				...
				content2Div1: "Đ_The Settings dialog is where you can change the appearance of your %TPL_NAME%. You change the layout, choose a different color scheme, change the text font, etc_ớ.",
				content2Div2: "Đ_You can also replace the Esri logo with your own logo to reflect your brand. You can also specify the website that will be launched if readers click your logo, so they can get more information_ớ.",
				...
				content6Div1: "Đ_The title of your Home section is also the title of your journal; think of your the Home section as  the 'cover page' to your story. The Home Section title will remain visible when your readers will navigate the Journal_ớ.",
			...
			firstAddSplash: {
				thisis: "Đây là",
				lblMain: "Đ_This is the %BR% Main Stage_ớ"
			}
        }
    })
);
