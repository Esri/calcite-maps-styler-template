define(
	 ({
		builder: {
			...
			addEditPopup: {
				disabled: "æ_Add Section is disabled because the maximum number of allowed sections has been reached._Â",
				titleAdd: "Ajouter une section",
				titleAddHome: "æ_Add Home Section_Â",
				titleEdit: "Modifier une section",
				step: "Etape",
				stepMainStageExplain: "æ_Main Stage Content_Â",
				stepPanelExplain: "æ_Content_Â",
				...
				firstAddExplain: "æ_This first section is your Home Section, think of it as the 'cover page' to your story. The title you just defined will be displayed with large fonts._Â",
				firstAddLeanMore: "æ_Learn More_Â",
			...
			exportData: {
				btn: "æ_Export content_Â",
				tooltip: "æ_Use this button to export your content locally. This will open a new page that you can easily copy or save as a PDF.<br />Copying that page content in a word processor is the most effective way to recreate your Journal in case of an accidental deletion._Â"
			},
			help: {
				lblHelp: "Aide",
				...
				content6Div1: "æ_The title of your Home section is also the title of your Journal; think of your the Home section as  the 'cover page' to your story. The Home Section title will remain visible when your readers will navigate the Journal._Â",
				content6Div2: "æ_Your %LAYOUT_TITLE% doesn't have to be just text, consider including photos and videos to help bring the story alive, and to break-up long sections of text!_Â"
			},
			landing: {
				lblAdd: "æ_What do you want to call your Map Journal?_Â",
				phAdd: "æ_Enter your title..._Â",
				lblOR: "Ou",
