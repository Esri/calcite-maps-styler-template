define(["dojo/Evented", "dojo/parser", "dojo/_base/declare", "dojo/_base/kernel", "dojo/_base/array", "dojo/_base/lang", "dojo/dom-class", "dojo/Deferred", "dojo/promise/all", "esri/arcgis/utils", "esri/urlUtils", "esri/request", "esri/config", "esri/lang", "esri/IdentityManager", "esri/tasks/GeometryService", "esriTemplate/commonConfig"

], function (
Evented, parser, declare, kernel, array, lang, domClass, Deferred, all, arcgisUtils, urlUtils, esriRequest, esriConfig, esriLang, IdentityManager, GeometryService, commonConfig) {
    var App = declare("utilities.App", [Evented], {
        ...
        _initializeApplication: function () {
            ...
            arcgisUtils.arcgisUrl = this.config.sharingurl + "/sharing/content/items";
            ...
            IdentityManager.checkSignInStatus(this.config.sharingurl + "/sharing").then(lang.hitch(this, function (credential) {
                return;
            }, function (error) {
                return;
            }));
        ...
        _queryUrlParams: function () {
            ...
            var paramItems = ["theme", "displayslider", "displaymeasure", "displaybasemaps", "displayoverviewmap", "displayeditor", "displaylegend", "displaysearch", "displaylayerlist", "displaybookmarks", "displaydetails", "displaytimeslider", "displayprint", "displayprintlegend", "displayeditortoolbar", "displaymapwidgets", "displayelevation", "displayscalebar", "displayshare", "leftpanelvisible", "embed", "constrainmapextent", "searchextent", "basemapgrouptitle", "basemapgroupowner", "gcsextent", "home"];
            var mixinParams = this._createUrlParamsObject(paramItems);
            lang.mixin(this.config, mixinParams);
        }
    });
