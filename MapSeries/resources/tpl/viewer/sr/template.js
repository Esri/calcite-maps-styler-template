define({
	root: ({
		viewer: {
			...
			loading: {
				long: "Č_Story is initializing_______ž",
			...
			mobileInfo: {
				...
				lblLegendMobileError: "Č_Sorry, the legend is unavailable. Please reload the story__________________ž.",
				lblLegendMobileErrorExplain: "Č_The legend is not available when the device is rotated to portrait mode after the story is loaded______________________________ž."
			},
			mobileFooter: {
				swipeInvite: "Č_Swipe to navigate the story_________ž",
				lblNext: "Č_Next__ž",
				lblEnd: "Č_You have reached the end of the story____________ž"
			},
			headerFromCommon: {
			...
			shareFromCommon: {
				...
				embedExplain: "Č_Use the following HTML code to embed the story in a web page___________________ž.",
