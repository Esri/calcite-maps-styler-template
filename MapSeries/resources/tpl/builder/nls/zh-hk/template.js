	 ...
	 ({
		builder: {
			...
			settingsLayoutOptions: {
				...
				lblDescription: "描述",
				lblLegend: "圖例放置",
				tooltipLegend: "選擇期望顯示地圖圖例的位置。可在新增或配置地圖時打開地圖圖例。",
				lblDropdown: "下拉式清單",
				lblBelowDesc: "在描述下方",
				lblOnPanel: "做為面板",
			...
			help: {
				...
				content1Div1: "要建立 %TPL_NAME%，請使用“新增”按鈕將各個地圖或其他內容新增到版面配置中。其他內容可包括圖像、影片或者嵌入式網頁或代碼。例如，您可能希望讀者在首次啟動 %TPL_NAME% 時先看到介紹圖像，然後再繼續瀏覽地圖。",
				content1Div2: "按一下“新增”按鈕時，將出現一個對話方塊，您可在其中選擇並配置想要新增的地圖或其他內容。例如，可指定希望地圖顯示的位置、啟用地圖圖例等等。",
				content2Div1: "可在“設定”對話方塊中變更 %TPL_NAME% 的外觀。變更版面配置，選擇其他配色方案，選擇地圖圖例的顯示位置等等。",
				...
				content6Div2: "例如，如果系列顯示城市的不同主題數據，讀者可縮放至鄰近區域，然後只需在索引標籤間切換即可查看不同區域的地圖。",
