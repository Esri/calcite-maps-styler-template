	 ...
	 ({
		builder: {
			layouts: {
				...
				tabDescr: "Dostępne mapy i inne treści używające kart z opcjonalnym panelem dla opisu.",
				tabItem: "Karta:",
				tabItems: "karta",
				sideTitle: "Boczne menu rozwijane pionowe",
				sideDescr: "Dostępne mapy i inne treści używające rozwijanego sterowania zawierającego opis.",
				sideItem: "Wpis",
				sideItems: "Wpisy",
				bulletTitle: "Wyróżniki",
				bulletDescr: "Dostępne mapy i inne treści używające wyróżników z opcjonalnym panelem dla opisu.",
			...
			settingsLayoutOptions: {
				...
				tooltipLegend: "Wybierz położenie, w którym ma być wyświetlana legenda do mapy. Można włączyć legendę dla dowolnej mapy podczas jej dodawania lub konfigurowania.",
				...
				lblPanelAccordion: "Panel menu rozwijanego pionowego",
				cfgLeft: "Lewy",
				cfgRight: "Prawy",
				cfgSmall: "Mały",
				cfgMedium: "Średni",
				...
				lblReverse: "Odwrotne numerowanie",
			...
			help: {
				...
				content1Div2: "Po kliknięciu przycisku Dodaj pojawi się okienko dialogowe pozwalające wybrać i skonfigurować mapę lub inne treści, które chcemy dodać. Można na przykład podać lokalizację, którą ma pokazywać mapa, włączyć legendę do mapy itp.",
				content2Div1: "W Ustawieniach można dokonać zmiany wyglądu aplikacji %TPL_NAME%. Można zmienić układ, wybrać innych schemat kolorów, wybrać położenie legendy do mapy itd.",
				...
				content3Div1: "Okienko dialogowe Organizuj pozwala na zarządzanie aplikacją %TPL_NAME%. Można w nim zmienić kolejność w serii poprzez przesuwanie i upuszczanie.",
				content3Div2: "Można również usunąć lub ukryć treści. Ukrywanie jest przydatne podczas przygotowywania nowej treści, która nie jest jeszcze gotowa na włączenie do story map.",
				...
				content6Div1: "Mapy w serii są domyślnie synchronizowane, aby pokazywać tę samą lokalizację. Oznacza to, że lokalizacja pokazana na pierwszej mapie zostanie automatycznie zastosowana dla pozostałych map i jeśli użytkownik powiększa widok lub przesuwa się do innej lokalizacji na aktualnie oglądanej mapie, wówczas zostanie to również zastosowane dla innych map.",
				...
				content6Div3: "Aby wyłączyć synchronizację lokalizacji, przejdź do Ustawień i wyłącz zaznaczenie tej opcji w karcie Opcje mapy",
				content6AltDiv1: "Lokalizacja map jest domyślnie synchronizowana. Wyłączenie synchronizacji umożliwi każdej mapie wyświetlanie innej lokalizacji.",
