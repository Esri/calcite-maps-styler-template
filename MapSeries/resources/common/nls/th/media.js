	 ...
	 ({
		commonMedia: {
			mediaSelector: {
				...
				lblVideo: "วิดีโอ",
				lblExternal: "เว็บเพจ",
				disabled: "ฟีเจอร์นี้ได้รับการแสดงโดยผู้ดูแลระบบ",
			...
			videoSelectorOther: {
				explain1: "โปรแกรมประยุกต์ไม่สามารถเล่นจากวิดีโอ เช่น avi mpeg  แต่สามารถเล่นวิดีโอไฟล์ของตัวเองที่มากับเครื่องเล่น เช่น ยูทูป หรือ วิมีโอ",
