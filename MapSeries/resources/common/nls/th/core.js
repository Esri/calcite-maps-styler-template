	 ...
	 ({
		commonCore: {
			...
			builderPanel: {
				...
				tooltipFirstSave: "สิ่งไม่สามารถใช้ได้จนกระทั่งคุณจัดเก็บ",
				tooltipNotShared: "สิ่งไม่สามารถใช้ได้จนกระทั่งคุณแบ่งปัน",
				...
				saveError: "จัดเก็บล้มเหลว กรุณาลองใหม่",
			...
			saveError: {
				...
				err1Div2: "กรุณาปรับปรุงชื่อของโปรแกรมประยุกต์ของคุณและจัดเก็บ",
