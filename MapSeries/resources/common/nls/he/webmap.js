	 ...
	 ({
		commonWebmap: {
			...
			editor: {
				...
				titleLbl: "כותרת",
				titlePh: "כותרת מפה...",
				folderLbl: "המפה תיווצר באותה תיקיה כשל הסיפור.",
				...
				notavailable2: "מצטערים, יצירה או עריכה של מפה אינה נתמכת משום שאפליקציית מפת הסיפור אינה מתארחת ב- %PRODUCT%. צור קשר עם מנהל ArcGIS לקבלת מידע נוסף.",
