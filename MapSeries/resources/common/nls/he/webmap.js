	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblLocation: "מיקום",
				lblContent: "תוכן",
				lblPopup: "כן_Pop-up___ש",
				lblControls: "תוספות",
				lblOverview: "מפת התמצאות",
				lblLegend: "מקרא",
				lblGeocoder: "כן_Address or Place Finder________ש",
				tooltipGeocoder: "כן_Allow your users to find addresses and places on your maps___________________ש.",
				...
				tooltipPopup: "כן_Choose a pop-up that will be opened when this map is displayed____________________ש.",
			...
			configure: {
				...
				popupTitle: "כן_Map pop-up____ש",
				popupExplain: "כן_Click on a feature to open the pop-up you want to display__________________ש.",
				popupSave: "כן_Save the pop-up configuration__________ש",
