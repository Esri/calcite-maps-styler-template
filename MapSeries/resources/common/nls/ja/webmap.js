	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblLocation: "位置",
				lblContent: "コンテンツ",
				lblPopup: "須_Pop-up___鷗",
				lblControls: "その他",
				lblOverview: "概観図",
				lblLegend: "凡例",
				lblGeocoder: "須_Address or Place Finder________鷗",
				tooltipGeocoder: "須_Allow your users to find addresses and places on your maps___________________鷗.",
				...
				tooltipPopup: "須_Choose a pop-up that will be opened when this map is displayed____________________鷗.",
			...
			configure: {
				...
				extentSave: "マップ位置の保存",
				popupTitle: "須_Map pop-up____鷗",
				popupExplain: "須_Click on a feature to open the pop-up you want to display__________________鷗.",
				popupSave: "須_Save the pop-up configuration__________鷗",
