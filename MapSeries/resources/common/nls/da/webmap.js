	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblContent: "Indhold",
				lblPopup: "ø_Pop-up___å",
				lblControls: "Ekstra",
				lblOverview: "Oversigtskort",
				lblLegend: "Signaturforklaring",
				lblGeocoder: "ø_Address or Place Finder________å",
				tooltipGeocoder: "ø_Allow your users to find addresses and places on your maps___________________å.",
				...
				tooltipPopup: "ø_Choose a pop-up that will be opened when this map is displayed____________________å.",
			...
			configure: {
				...
				popupTitle: "ø_Map pop-up____å",
				popupExplain: "ø_Click on a feature to open the pop-up you want to display__________________å.",
				popupSave: "ø_Save the pop-up configuration__________å",
