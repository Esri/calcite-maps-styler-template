	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblContent: "Contenu",
				lblPopup: "æ_Pop-up___Â",
				lblControls: "Suppléments",
				lblOverview: "Vue générale",
				lblLegend: "Légende",
				lblGeocoder: "æ_Address or Place Finder________Â",
				tooltipGeocoder: "æ_Allow your users to find addresses and places on your maps___________________Â.",
				...
				tooltipPopup: "æ_Choose a pop-up that will be opened when this map is displayed____________________Â.",
			...
			configure: {
				...
				popupTitle: "æ_Map pop-up____Â",
				popupExplain: "æ_Click on a feature to open the pop-up you want to display__________________Â.",
				popupSave: "æ_Save the pop-up configuration__________Â",
