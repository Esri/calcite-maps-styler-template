	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblContent: "Saturs",
				lblPopup: "ķ_Pop-up___ū",
				lblControls: "Papildu",
				lblOverview: "Pārskata karte",
				lblLegend: "Apzīmējumi",
				lblGeocoder: "ķ_Address or Place Finder________ū",
				tooltipGeocoder: "ķ_Allow your users to find addresses and places on your maps___________________ū.",
				...
				tooltipPopup: "ķ_Choose a pop-up that will be opened when this map is displayed____________________ū.",
			...
			configure: {
				...
				popupTitle: "ķ_Map pop-up____ū",
				popupExplain: "ķ_Click on a feature to open the pop-up you want to display__________________ū.",
				popupSave: "ķ_Save the pop-up configuration__________ū",
