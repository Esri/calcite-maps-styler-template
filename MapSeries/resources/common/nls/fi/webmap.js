	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblContent: "Sisältö",
				lblPopup: "Å_Pop-up___ö",
				lblControls: "Ylimääräinen sisältö",
				lblOverview: "Yleiskatsauskartta",
				lblLegend: "Selite",
				lblGeocoder: "Å_Address or Place Finder________ö",
				tooltipGeocoder: "Å_Allow your users to find addresses and places on your maps___________________ö.",
				...
				tooltipPopup: "Å_Choose a pop-up that will be opened when this map is displayed____________________ö.",
			...
			configure: {
				...
				popupTitle: "Å_Map pop-up____ö",
				popupExplain: "Å_Click on a feature to open the pop-up you want to display__________________ö.",
				popupSave: "Å_Save the pop-up configuration__________ö",
