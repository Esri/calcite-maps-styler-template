	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblLocation: "Locatie",
				lblContent: "Content",
				lblPopup: "Ĳ_Pop-up___ä",
				lblControls: "Extra\'s",
				lblOverview: "Overzichtskaart",
				lblLegend: "Legenda",
				lblGeocoder: "Ĳ_Address or Place Finder________ä",
				tooltipGeocoder: "Ĳ_Allow your users to find addresses and places on your maps___________________ä.",
				...
				tooltipPopup: "Ĳ_Choose a pop-up that will be opened when this map is displayed____________________ä.",
			...
			configure: {
				...
				popupTitle: "Ĳ_Map pop-up____ä",
				popupExplain: "Ĳ_Click on a feature to open the pop-up you want to display__________________ä.",
				popupSave: "Ĳ_Save the pop-up configuration__________ä",
