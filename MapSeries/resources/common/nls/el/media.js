	 ...
	 ({
		commonMedia: {
			mediaSelector: {
				...
				url: "Για να εισαγάγετε μη αυτόματα τη διεύθυνση web μιας εικόνας",
			...
			imageSelectorPicasa: {
				userInputLbl: "Email ή ID Picasa/Google+",
			...
			videoSelectorOther: {
				...
				explain3: "Εναλλακτικά, εάν θέλετε να φιλοξενήσετε εσείς το βίντεο, μπορείτε να δημιουργήσετε μια σελίδα HTML που χρησιμοποιεί ένα πρόγραμμα αναπαραγωγής βίντεο όπως το %EXAMPLE%, να φιλοξενήσετε τη σελίδα αυτή και να χρησιμοποιήσετε επίσης το %WEBPAGE%.",
				webpage: "Χαρακτηριστικό ιστοσελίδας"
			},
			webpageSelectorHome: {
				lblUrl: "URL ιστοσελίδας",
				lblEmbed: "Κώδικας ενσωμάτωσης",
				lblOR: "Ή",
			...
			mediaConfigure: {
				...
				lblURLError: "Η εικόνα αυτή δεν φαίνεται να είναι έγκυρη. Καθορίστε μια απευθείας σύνδεση σε ένα αρχείο εικόνας (το URL θα τελειώνει συνήθως σε .jpg ή .png). Οι συνδέσεις σε μια ιστοσελίδα που περιέχει μια εικόνα δεν λειτουργούν.",
			...
			editorActionGeocode: {
				...
				mapMarkerExplain: "Ο χρήστης θα βλέπει έναν δείκτη χάρτη όταν κάνει κλικ στη σύνδεση"
			},
			editorActionMedia: {
