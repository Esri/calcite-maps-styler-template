	 ...
	 ({
		commonCore: {
			...
			saveError: {
				...
				err1Div1: "Δεν είναι δυνατή η αποθήκευση της εφαρμογής, επειδή έχετε ήδη ένα άλλο στοιχείο με το ίδιο όνομα (δείτε το <a class='linkagolroot' target='_blank'>φάκελο περιεχομένου</a> σας).",
			...
			share: {
				...
				firstSaveA1: "Εάν δεν είστε εξοικειωμένοι με το %PORTAL% ή θέλετε μια συντόμευση για πρόσβαση στο περιβάλλον εργασίας του εργαλείου δημιουργίας, μπορείτε να αποθηκεύσετε τη σύνδεση %LINK1%",
				...
				sharePrivateWarning: "Η κοινοποίηση %WITH% έχει απενεργοποιηθεί επειδή δεν είστε ο κάτοχος του <a href='%LINK%' target='_blank'>χάρτη web</a>.",
				sharePrivateWarningWith1: "δημοσίως",
				sharePrivateWarningWith2: "δημοσίως και στον οργανισμό",
				...
				shareA1: "Χρησιμοποιήστε το %SHAREIMG% στη <a href='%LINK1%' target='_blank'>σελίδα στοιχείου της εφαρμογής</a>.",
				shareQ2bis: "Πώς μπορώ να επιστρέψω στο περιβάλλον εργασίας του εργαλείου δημιουργίας;",
				...
				shareA3: "Τα δεδομένα και η διαμόρφωση του %TPL_NAME% αποθηκεύονται σε αυτό το <a href='%LINK2%' target='_blank'>στοιχείο εφαρμογής web</a>. Εάν έχετε χρησιμοποιήσει εισαγωγή από Flickr, Picasa, Facebook ή YouTube, οι εικόνες και τα βίντεό σας δεν έχουν αναπαραχθεί στο %PORTAL%."
			},
			settings: {
				header: "Ρυθμίσεις",
			...
			settingsLayout: {
				...
				viewExample: "Δείτε ένα ζωντανό παράδειγμα"
			},
			settingsTheme: {
				title: "Θέμα"
			},
			settingsHeader: {
				...
				logoCustomTargetPlaceholder: "Ενσωματωμένη σύνδεση",
				logoSocialExplain: "Προσαρμόστε τη σύνδεση της κεφαλίδας.",
				logoSocialText: "Κείμενο",
				logoSocialLink: "Σύνδεση",
