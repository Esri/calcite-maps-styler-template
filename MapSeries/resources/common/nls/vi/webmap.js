	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblLocation: "Vị trí",
				lblContent: "Nội dung",
				lblPopup: "Đ_Pop-up___ớ",
				lblControls: "Ứng dụng phụ",
				lblOverview: "Bản đồ Toàn cảnh",
				lblLegend: "Chú giải",
				lblGeocoder: "Đ_Address or Place Finder________ớ",
				tooltipGeocoder: "Đ_Allow your users to find addresses and places on your maps___________________ớ.",
				...
				tooltipPopup: "Đ_Choose a pop-up that will be opened when this map is displayed____________________ớ.",
			...
			configure: {
				...
				popupTitle: "Đ_Map pop-up____ớ",
				popupExplain: "Đ_Click on a feature to open the pop-up you want to display__________________ớ.",
				popupSave: "Đ_Save the pop-up configuration__________ớ",
