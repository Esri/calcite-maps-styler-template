	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblLocation: "Asukoht",
				lblContent: "Sisu",
				lblPopup: "Š_Pop-up___ä",
				lblControls: "Lisandid",
				lblOverview: "Ülevaatekaart",
				lblLegend: "Legend",
				lblGeocoder: "Š_Address or Place Finder________ä",
				tooltipGeocoder: "Š_Allow your users to find addresses and places on your maps___________________ä.",
				...
				tooltipPopup: "Š_Choose a pop-up that will be opened when this map is displayed____________________ä.",
			...
			configure: {
				...
				popupTitle: "Š_Map pop-up____ä",
				popupExplain: "Š_Click on a feature to open the pop-up you want to display__________________ä.",
				popupSave: "Š_Save the pop-up configuration__________ä",
