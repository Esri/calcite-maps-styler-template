	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblContent: "Zasoby",
				lblPopup: "ł_Pop-up___ą",
				lblControls: "Dodatki",
				lblOverview: "Mapa przeglądowa",
				lblLegend: "Legenda",
				lblGeocoder: "ł_Address or Place Finder________ą",
				tooltipGeocoder: "ł_Allow your users to find addresses and places on your maps___________________ą.",
				...
				tooltipPopup: "ł_Choose a pop-up that will be opened when this map is displayed____________________ą.",
			...
			configure: {
				...
				popupTitle: "ł_Map pop-up____ą",
				popupExplain: "ł_Click on a feature to open the pop-up you want to display__________________ą.",
				popupSave: "ł_Save the pop-up configuration__________ą",
