	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblPopup: "é_Pop-up___È",
				lblControls: "Extra",
				lblOverview: "Mappa d\'insieme",
				lblLegend: "Legenda",
				lblGeocoder: "é_Address or Place Finder________È",
				tooltipGeocoder: "é_Allow your users to find addresses and places on your maps___________________È.",
				...
				tooltipPopup: "é_Choose a pop-up that will be opened when this map is displayed____________________È.",
			...
			configure: {
				...
				popupTitle: "é_Map pop-up____È",
				popupExplain: "é_Click on a feature to open the pop-up you want to display__________________È.",
				popupSave: "é_Save the pop-up configuration__________È",
