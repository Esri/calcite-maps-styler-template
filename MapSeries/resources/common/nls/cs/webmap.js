	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblContent: "Obsah",
				lblPopup: "Ř_Pop-up___ů",
				lblControls: "Doplňky",
				lblOverview: "Mapa přehledu",
				lblLegend: "Legenda",
				lblGeocoder: "Ř_Address or Place Finder________ů",
				tooltipGeocoder: "Ř_Allow your users to find addresses and places on your maps___________________ů.",
				...
				tooltipPopup: "Ř_Choose a pop-up that will be opened when this map is displayed____________________ů.",
			...
			configure: {
				...
				popupTitle: "Ř_Map pop-up____ů",
				popupExplain: "Ř_Click on a feature to open the pop-up you want to display__________________ů.",
				popupSave: "Ř_Save the pop-up configuration__________ů",
