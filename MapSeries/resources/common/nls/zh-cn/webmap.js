	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblLocation: "位置",
				lblContent: "内容",
				lblPopup: "试_Pop-up___验",
				lblControls: "额外部分",
				lblOverview: "总览图",
				lblLegend: "图例",
				lblGeocoder: "试_Address or Place Finder________验",
				tooltipGeocoder: "试_Allow your users to find addresses and places on your maps___________________验.",
				loadingTitle: "加载标题",
				entry: "条目",
				entries: "条目",
				section: "节",
				...
				tooltipPopup: "试_Choose a pop-up that will be opened when this map is displayed____________________验.",
			...
			configure: {
				...
				extentSave: "保存地图位置",
				popupTitle: "试_Map pop-up____验",
				popupExplain: "试_Click on a feature to open the pop-up you want to display__________________验.",
				popupSave: "试_Save the pop-up configuration__________验",
