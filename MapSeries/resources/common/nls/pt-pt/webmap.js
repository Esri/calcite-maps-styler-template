	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblContent: "Conteúdo",
				lblPopup: "ã_Pop-up___Ç",
				lblControls: "Extras",
				lblOverview: "Vista Geral do Mapa",
				lblLegend: "Legenda",
				lblGeocoder: "ã_Address or Place Finder________Ç",
				tooltipGeocoder: "ã_Allow your users to find addresses and places on your maps___________________Ç.",
				...
				tooltipPopup: "ã_Choose a pop-up that will be opened when this map is displayed____________________Ç.",
			...
			configure: {
				...
				popupTitle: "ã_Map pop-up____Ç",
				popupExplain: "ã_Click on a feature to open the pop-up you want to display__________________Ç.",
				popupSave: "ã_Save the pop-up configuration__________Ç",
