	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				lblContent: "Innhold",
				lblPopup: "å_Pop-up___ø",
				lblControls: "Tillegg",
				lblOverview: "Oversiktskart",
				lblLegend: "Tegnforklaring",
				lblGeocoder: "å_Address or Place Finder________ø",
				tooltipGeocoder: "å_Allow your users to find addresses and places on your maps___________________ø.",
				...
				tooltipPopup: "å_Choose a pop-up that will be opened when this map is displayed____________________ø.",
			...
			configure: {
				...
				popupTitle: "å_Map pop-up____ø",
				popupExplain: "å_Click on a feature to open the pop-up you want to display__________________ø.",
				popupSave: "å_Save the pop-up configuration__________ø",
