define({
	header: {
		...
		totalStories: "Nombre total de récits: {{NUM_STORIES}}",
		noIssues: "Tout va bien",
		userStories: "Récits appartenant à {{USER_NAME}}",
	...
	deleteModal: {
		...
		warningText: "Souhaitez-vous vraiment supprimer ce récit? Vous ne pourrez pas le récupérer.",
		deleteText: "Effacer",
		cancel: "Annuler" 
	},
	loading: {
	...
	cantFindStories: {
		...
		notSeeExplanation: "Mes récits répertorie uniquement les Story Maps hébergées dans ArcGIS Online et créées avec {{STORY_MAP_TOUR}}, {{JOURNAL}}, {{MAP_SERIES}} et {{SWIPE_SPYGLASS}}. Consultez notre {{FAQ}} pour en savoir plus.",
		faq: "FAQ",
		followingStoriesToUpdate: "Les récits suivants, créés avec des versions antérieures de nos applications, doivent être mis à jour pour être répertoriés dans Mes récits:",
		...
		reloadingStories: "Rechargement de vos récits...",
	...
	signIn: {
		...
		signInTo: "Connectez-vous via votre compte ArcGIS Online à :",
		explanationOne: "Créez des Story Maps captivantes pour partager vos récits.",
		...
		dontHaveAccount: "Vous n'avez pas de compte ArcGIS Online ? Inscrivez-vous pour bénéficier d'un :",
	...
	collectionList: [
		...
		"Catastrophes et reconstruction",           
	...
	storyMap: {
		...
		galleryTip: "{{THE_GALLERY}} est un ensemble proposé de Story Maps qui expose certains des meilleurs exemples. Si votre récit est sélectionné, il sera ajouté dans les 10 jours suivant sa soumission. Vu le nombre important de récits proposés, nous ne pouvons garantir la sélection du vôtre." 
		},
		placeholders: {
	...
	content: {
		...
		sidePanel: "contenu du volet latéral" 
		},
		notification: {
		...
		notCompatibleWithBrowser : "Mes récits ne sont pas pris en charge dans les versions d'Internet Explorer antérieures à la version {{VERSION_NUMBER}}.",
		...
		layerNotYoursNotAccessible: "La couche {{LAYER_NAME}} appartient à un autre utilisateur et n'est pas accessible",
		layerServiceOkItemNot: "La couche {{LAYER_NAME}} a été ajoutée en tant qu'élément supprimé ou inaccessible",
		mapOthersSharedBelowLevel: "La carte ne vous appartient pas et n'est pas publique",
		layerOthersSharedBelowLevel: "La couche {{LAYER_NAME}} ne vous appartient pas et n'est pas publique",
		...
		layerIsPrivate: "La couche {{LAYER_NAME}} est privée",
		layerIsOrg: "La couche {{LAYER_NAME}} est uniquement partagée avec votre organisation",
		...
		layerSecureService: "La couche {{LAYER_NAME}} est un service sécurisé",
		mapSecureService: "La carte est un service sécurisé",
		layerConsumesCredits: "La couche {{LAYER_NAME}} est un contenu premium qui utilise des crédits",
		layerSubscriptionContent: "La couche {{LAYER_NAME}} est un contenu lié à l'abonnement",
		...
		cantScanThisType: "Nous ne pouvons pas vérifier le type de la couche {{LAYER_NAME}}",
		...
		othersSharedBelowLevelTip: "Astuce : une partie du contenu de votre récit appartient à {{USER_NAME}} et les utilisateurs qui consultent votre récit risquent de ne pas le voir.",		
	...
	progress: {
		...
		scanStopped: "Récits analysés : {{NUM_SCANNED}}, Récits présentant des erreurs : {{ISSUE_STORIES}}",
		storiesWithIssues: "Récits présentant des erreurs : {{NUM_STORIES}}" 
	}	
});
