define(['dojo/i18n!my-stories-utils/create-app/nls/app.js', 'dojo/domReady!'], function(createStoryi18n) {
	'use strict';
	...
	apps = {
		mapTour: {
			...
			value: 'mapTour',
			method: 'buildTour()',
			thumbnail: './my-stories-utils/create-app/assets/images/map-tour.jpg',
		...
		mapJournal: {
			...
			value: 'mapJournal',
			method: 'buildJournal()',
			thumbnail: 'my-stories-utils/create-app/assets/images/map-journal.jpg',
		...
		mapSeries: {
			...
			value: 'mapSeries',
			method: 'buildSeries()',
			thumbnail: 'my-stories-utils/create-app/assets/images/tabbed-viewer.jpg',
		...
		swipeSpyglass: {
			...
			thumbnail: 'my-stories-utils/create-app/assets/images/swipe.jpg',
			thumbnailTwo: 'my-stories-utils/create-app/assets/images/spyglass.jpg',
		...
		basic: {
			...
			multiple: false,
			value: 'basic',
			method: '/en/app-list/basic/tutorial/',
			thumbnail: 'my-stories-utils/create-app/assets/images/basic.jpg',
	...
	createStory = function() {
		...
		*/
		templatizeCreateStory = function() {
			var template = Handlebars.templates['createStory'];
			
			$('#create-story-modal').html(template(
				{
					strings: strings,
					appTypes: appTypes,
		...
		*/
		...
		templatizeQuestion = function(question) {
			var template = Handlebars.templates['question'];

			var questionWidget = template({
				question: question
			});
	...
	// we use this in My Stories for implementation ease -- we'd have to wait to run My Stories until createApp and Templates are back, and we don't want to wait any longer
	window.CreateStoryDialog = createStory;
