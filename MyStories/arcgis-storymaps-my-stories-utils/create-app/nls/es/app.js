define({
  "dialog": {
    "back": "Atrás",
    "close": "Cerrar",
    "createNewStory": "Crea una nueva historia",
    "pickApp": "Elige una aplicación",
    "askPros": "Pregunta a los profesionales"
  },
  "incompatibleNotice": {
  ...
  "answerText": {
    ...
    "compareDatasets": "Una comparación interactiva de dos datasets",
    "other": "Un solo mapa",
    "yes": "Sí",
    "no": "No",
    "click": "Clic",
  ...
  "reasons": {
    ...
    "mapJournal": "Esta aplicación te permite crear una atractiva narración basada en mapas presentada como un conjunto de entradas de diario. Resulta ideal para crear historias multimedia que combinen texto, mapas, imágenes y vídeo, especialmente cuando hay mucho texto y mucho contenido.",
