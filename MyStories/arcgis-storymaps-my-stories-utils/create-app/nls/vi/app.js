define({
  "dialog": {
    "back": "Quay lại",
    "close": "Đóng",
    "createNewStory": "Tạo Câu chuyện Mới",
    "pickApp": "Chọn Ứng dụng",
    "askPros": "Hỏi Chuyên gia"
  },
  "incompatibleNotice": {
  ...
  "answerText": {
    ...
    "compareDatasets": "So sánh tương tác hai bộ dữ liệu",
  ...
  "finalApp": {
    ...
    "letsBuild": "Hãy cùng xây dựng nào!",
    "seeExample": "Xem ví dụ"
  },
  "reasons": {
    ...
    "mapJournal": "Ứng dụng này cho phép bạn trình bày một bản đồ hấp dẫn dựa trên câu chuyện được sắp xếp thành một tập hợp các mục bài viết. Đây là ứng dụng lý tưởng để tạo ra những câu chuyện đa phương tiện kết hợp văn bản, bản đồ, hình ảnh và video, đặc biệt là khi bạn có rất nhiều văn bản và nội dung mà bạn muốn truyền tải.",
  ...
  "shortReasons": {
    ...
    "mapJournal": "Lựa chọn hoàn hảo cho câu chuyện có chiều sâu",
    "mapSeries": "Trình bày chuỗi bản đồ liên quan",
    "swipe": "So sánh hai bản đồ hoặc lớp bản đồ bằng thanh trượt",
