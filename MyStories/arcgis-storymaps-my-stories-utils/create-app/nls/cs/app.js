define(
	 ({
		dialog: {
			back: "Zpět",
			close: "Zavřít",
			createNewStory: "Vytvořte nový příběh",
			pickApp: "Vyberte si aplikaci",
			askPros: "Zeptejte se profesionálů"
		},
		incompatibleNotice: {
		...
		answerText: {
			...
			compareDatasets: "Interaktivní porovnání dvou datových sad",
			other: "Jedna mapa",
			yes: "Ano",
			no: "Ne",
			click: "Klepněte na",
		...
		finalApp: {
			...
			letsBuild: "Pojďme tvořit!",
			seeExample: "Viz příklad"
		},
		reasons: {
			...
			mapJournal: "Tato aplikace vám umožní vytvořit poutavý příběh založený na mapě prezentovaný ve formě sbírky deníkových zápisů. Je ideální k vytváření multimediálních příběhů, které kombinují text, mapy, obrázky a video, zvláště pokud máte hodně textu nebo velké množství obsahu.",
		...
		shortReasons: {
			...
			mapJournal: "Dokonalé pro propracované příběhy",
			mapSeries: "Prezentujte řadu souvisejících map",
			swipe: "Porovnávejte dvě mapy nebo mapové vrstvy pomocí posuvníku",
