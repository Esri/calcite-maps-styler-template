...
define({
  ...
  "urlItems": [
    "theme", "showtitle","showpanel","showdescription","legend","activepanel","share","search","table","layerlist","bookmarks","print","locate", "basemaps","home"// example param. ?theme=<my theme>
  ],
