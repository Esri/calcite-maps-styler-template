...
Counter.prototype.finishLoading = function() {
   ...
   for ( i = 0; i < this.digitsNumber; i++) {
      ...
      if (i == 0)
         a.className += " counter_character_left" + (this.extraClassName.left ? " " : "") + this.extraClassName.left;
      else if (i == this.digitsNumber - 1)
         a.className += " counter_character_right" + (this.extraClassName.right ? " " : "") + this.extraClassName.right;
      else
         a.className += " counter_character_inner" + (this.extraClassName.inner ? " " : "") + this.extraClassName.inner;
...
Counter.prototype.animate = function(a) {
   ...
   for ( i = 0; i < this.beforeAnimation.length; i++) {
      ...
      if (c) {
         var d = 0.0;
         if (this.animationProgress < 1)
            d = this.beforeAnimation[i] + (this.afterAnimation[i] - this.beforeAnimation[i]) * this.animationProgress;
         else {
