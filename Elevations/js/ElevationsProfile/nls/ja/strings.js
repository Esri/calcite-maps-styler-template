define({
  display: {
    elevationProfileTitle: "須_Elevation Profile_鷗",
    showMe: "表示",
    ...
    hoverOver: "須_Hover over or touch the Elevation Profile chart to display elevations and show location on map_鷗."
  },
  buttons: {
    measureLabel: "計測",
    helpLabel: "ヘルプ"
