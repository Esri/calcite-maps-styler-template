define({
  display: {
    elevationProfileTitle: "ø_Elevation Profile_å",
    showMe: "vis mig",
    ...
    hoverOver: "ø_Hover over or touch the Elevation Profile chart to display elevations and show location on map_å."
  },
  buttons: {
    measureLabel: "Mål",
    helpLabel: "Hjælp"
