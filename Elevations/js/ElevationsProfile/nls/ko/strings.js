define({
  display: {
    elevationProfileTitle: "한_Elevation Profile_빠",
    showMe: "표시",
    ...
    hoverOver: "한_Hover over or touch the Elevation Profile chart to display elevations and show location on map_빠."
  },
  buttons: {
    measureLabel: "측정",
    helpLabel: "도움말"
