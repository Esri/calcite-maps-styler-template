define({
  display: {
    elevationProfileTitle: "Ă_Elevation Profile_ș",
    showMe: "arată",
    ...
    hoverOver: "Ă_Hover over or touch the Elevation Profile chart to display elevations and show location on map_ș."
  },
  buttons: {
