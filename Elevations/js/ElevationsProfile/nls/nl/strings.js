define({
  display: {
    elevationProfileTitle: "Ĳ_Elevation Profile_ä",
    showMe: "mij tonen",
    ...
    hoverOver: "Ĳ_Hover over or touch the Elevation Profile chart to display elevations and show location on map_ä."
  },
  buttons: {
    measureLabel: "Meten",
    helpLabel: "Help"
