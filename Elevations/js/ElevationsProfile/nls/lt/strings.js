define({
  display: {
    elevationProfileTitle: "Į_Elevation Profile_š",
    showMe: "parodyti",
    ...
    hoverOver: "Į_Hover over or touch the Elevation Profile chart to display elevations and show location on map_š."
  },
  buttons: {
