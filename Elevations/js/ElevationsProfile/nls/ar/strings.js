define({
  display: {
    elevationProfileTitle: "بيت_Elevation Profile_لاحقة",
    showMe: "عرض",
    ...
    hoverOver: "بيت_Hover over or touch the Elevation Profile chart to display elevations and show location on map_لاحقة."
  },
  buttons: {
    measureLabel: "قياس",
    helpLabel: "تعليمات"
  ...
  chart: {
    title: "بيت_Elevation Profile_لاحقة",
