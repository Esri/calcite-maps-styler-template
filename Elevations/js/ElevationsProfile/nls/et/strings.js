define({
  display: {
    elevationProfileTitle: "Š_Elevation Profile_ä",
    showMe: "näita",
    ...
    hoverOver: "Š_Hover over or touch the Elevation Profile chart to display elevations and show location on map_ä."
  },
  buttons: {
    measureLabel: "Mõõda",
    helpLabel: "Abi"
