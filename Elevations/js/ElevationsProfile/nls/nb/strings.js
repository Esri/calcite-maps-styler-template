define({
  display: {
    elevationProfileTitle: "å_Elevation Profile_ø",
    showMe: "vis meg",
    ...
    hoverOver: "å_Hover over or touch the Elevation Profile chart to display elevations and show location on map_ø."
  },
  buttons: {
    measureLabel: "Mål",
    helpLabel: "Hjelp"
