define({
  display: {
    elevationProfileTitle: "试_Elevation Profile_验",
    showMe: "显示",
    ...
    hoverOver: "试_Hover over or touch the Elevation Profile chart to display elevations and show location on map_验."
  },
  buttons: {
    measureLabel: "测量",
    helpLabel: "帮助"
