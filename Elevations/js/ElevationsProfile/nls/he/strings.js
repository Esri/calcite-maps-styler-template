define({
  display: {
    elevationProfileTitle: "כן_Elevation Profile_ש",
    showMe: "הצג בפניי",
    ...
    hoverOver: "כן_Hover over or touch the Elevation Profile chart to display elevations and show location on map_ש."
  },
  buttons: {
    measureLabel: "מדידה",
    helpLabel: "עזרה"
