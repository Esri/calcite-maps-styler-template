define(
   ({
    display: {
      ...
      showMe: "βοήθεια",
      selectLine: "<b>Επιλέξτε</b> ένα χαρακτηριστικό στο χάρτη.",
      popupRequirement: "ΣΗΜΕΙΩΣΗ: Το χαρακτηριστικό πρέπει να βρίσκεται σε ένα επίπεδο με ενεργοποιημένα αναδυόμενα παράθυρα.",
    ...
    errors: {
      MissingConstructorParameters: "Απουσία παραμέτρου κατασκευής.",
