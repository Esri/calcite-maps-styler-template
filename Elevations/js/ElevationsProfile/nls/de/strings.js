define({
  display: {
    elevationProfileTitle: "ä_Elevation Profile_Ü",
    showMe: "anzeigen",
    ...
    hoverOver: "ä_Hover over or touch the Elevation Profile chart to display elevations and show location on map_Ü."
  },
  buttons: {
    measureLabel: "Messen",
    helpLabel: "Hilfe"
