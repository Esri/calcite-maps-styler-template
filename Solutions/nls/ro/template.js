...
({
        tooltips: {
            ...
            dijitLegend: "Ă_Show the legend_ș",  //Display the legend
        ...
        prompts: {
            ...
            layerFields: "Ă_Find layer fields:_ș"  // Appears before a list of fields in the configured map find layer; shown when the app cannot find one or more of the fields that were configured for the find command; works with the searchFieldMissing message
        },
        messages: {
