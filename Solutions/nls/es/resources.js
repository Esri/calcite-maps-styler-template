...
define(
    ({
        ...
        messages: {
            ...
            searchLayerNotSearchable: "No se pueden encontrar campos para la capa de mapa.<br><br>Comprueba que esta capa existe en la raíz del contenido del mapa. Los servicios anidados, como los servicios de mapas dinámicos de ArcGIS for Server, se deben agregar al mapa de capa en capa (incluido el número del índice de la capa) para usarlos como Buscar capas. Los servicios en teselas no se pueden usar como Buscar capas.",
