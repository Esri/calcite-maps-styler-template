...
define(
    ({
        ...
        messages: {
            ...
            searchLayerNotSearchable: "Nie znaleziono pól dla tej warstwy mapy.<br><br>Upewnij się, że warstwa ta istnieje w głównej treści mapy. Zagnieżdżone usługi, takie jak usługi map dynamicznych ArcGIS for Server, należy dodawać do mapy po jednej warstwie na raz (łącznie z numerem indeksu warstwy), aby można je było wykorzystać w funkcji Znajdź warstwy. Usług kafelkowych nie można wykorzystywać w funkcji Znajdź warstwy.",
