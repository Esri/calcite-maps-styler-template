...
define(
    ({
        ...
        messages: {
            ...
            searchLayerNotSearchable: "Nebyla nalezena pole pro vrstvu mapy.<br><br>Ujistěte se, že se tato vrstva nachází v kořenovém umístění obsahu mapy. Vnořené služby, jako jsou například služby dynamické mapy ArcGIS for Server, je nutné do mapy přidat po jedné vrstvě (včetně čísla indexu vrstvy), aby bylo možné je používat s vyhledáváním vrstev. Dlaždicové služby nelze používat s vyhledáváním vrstev.",
