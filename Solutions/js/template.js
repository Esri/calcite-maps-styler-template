...
define([
    ...
    return declare([Evented], {
        ...
        _getUrlParamValues: function (items) {
            ...
            var urlObject = this.urlObject, obj = {}, i, item;
        ...
        queryItem: function () {
            var deferred, cfg = {}, defaultWebmap;
        ...
        queryApplication: function () {
            ...
            var deferred = new Deferred(), layerMixins;
            if (this.config.appid) {
                arcgisUtils.getItem(this.config.appid).then(lang.hitch(this, function (response) {
                    ...
                    if (response.item && response.item.appProxies) {
                        layerMixins = array.map(response.item.appProxies, function (p) {
                            return {
                                "url": p.sourceUrl,
                                "mixin": {
                                    "url": p.proxyUrl
                ...
                esriRequest({
                    ...
                    if (this.templateConfig.webTierSecurity) {
                        ...
                        if (response.authorizedCrossOriginDomains && response.authorizedCrossOriginDomains.length) {
                            for (i = 0; i < response.authorizedCrossOriginDomains.length; i++) {
