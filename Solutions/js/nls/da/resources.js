...
define(
    ({
        map: {
            error: "ø_Unable to create the map_å"
        },
        tooltips: {
        ...
        messages: {
            ...
            noSearchLayerConfigured: "Der er ikke konfigureret søgning efter lager",  // Appears before a list of map layers; shown when the app is not configured with any layers to use for the find command; works with the mapLayers prompt
