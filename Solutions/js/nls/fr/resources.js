...
define(
    ({
        map: {
            error: "æ_Unable to create the map_Â"
        },
        tooltips: {
        ...
        messages: {
            ...
            noSearchLayerConfigured: "Aucune couche permettant d\'effectuer des recherches n\'a été configurée",  // Appears before a list of map layers; shown when the app is not configured with any layers to use for the find command; works with the mapLayers prompt
