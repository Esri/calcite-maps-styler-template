...
define(
    ({
        map: {
            error: "å_Unable to create the map_ø"
        },
        tooltips: {
            ...
            dijitLegend: "Vis tegnforklaringen",  //Display the legend
        ...
        prompts: {
            ...
            layerFields: "Søk etter lagfelter:"  // Appears before a list of fields in the configured map find layer; shown when the app cannot find one or more of the fields that were configured for the find command; works with the searchFieldMissing message
        },
        messages: {
            ...
            noSearchLayerConfigured: "Det er ingen konfigurerte søkelag",  // Appears before a list of map layers; shown when the app is not configured with any layers to use for the find command; works with the mapLayers prompt
            ...
            searchLayerNotSearchable: "Fant ikke feltene for kartlaget.<br><br>Kontroller at dette laget eksisterer i roten i kartet Innhold. Flettede tjenester, f.eks. ArcGIS for Servers dynamiske karttjenester, må legges til kartet med ett lag om gangen (inkludert kartets indeksnummer) som skal brukes om Finn lag. Flisetjenestester kan ikke brukes som Finn lag.",
