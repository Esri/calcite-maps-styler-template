...
define(
    ({
        ...
        messages: {
            ...
            noSearchLayerConfigured: "Ř_No find layer has been configured_ů",  // Appears before a list of map layers; shown when the app is not configured with any layers to use for the find command; works with the mapLayers prompt
