...
define(
    ({
        map: {
            error: "ä_Unable to create the map_Ü"
        },
        tooltips: {
        ...
        messages: {
            ...
            noSearchLayerConfigured: "Es wurde kein Such-Layer konfiguriert",  // Appears before a list of map layers; shown when the app is not configured with any layers to use for the find command; works with the mapLayers prompt
