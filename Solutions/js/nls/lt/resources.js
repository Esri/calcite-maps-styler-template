...
define(
    ({
        map: {
            error: "Į_Unable to create the map_š"
        },
        tooltips: {
        ...
        messages: {
            ...
            noSearchLayerConfigured: "Nėra sukonfigūruoto paieškos sluoksnio",  // Appears before a list of map layers; shown when the app is not configured with any layers to use for the find command; works with the mapLayers prompt
