...
define(
    ({
        map: {
            error: "Å_Unable to create the map_ö"
        },
        tooltips: {
        ...
        messages: {
            ...
            noSearchLayerConfigured: "Inget söklager har konfigurerats",  // Appears before a list of map layers; shown when the app is not configured with any layers to use for the find command; works with the mapLayers prompt
