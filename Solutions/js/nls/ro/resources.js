...
define(
    ({
        ...
        messages: {
            ...
            noSearchLayerConfigured: "Nu a fost configurat niciun strat tematic de căutare",  // Appears before a list of map layers; shown when the app is not configured with any layers to use for the find command; works with the mapLayers prompt
            ...
            noConfiguration: "Nu se poate accesa configuraţia aplicaţiei",  // Appears if the app, during startup, cannot get access to or find the configuration information; without the information, it cannot build the UI
