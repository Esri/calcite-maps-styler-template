...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "Š_Start on point no._ä"
			},
			builderHTML: {
				...
				organizeWarning: "Š_One or multiple points added outside of the interactive builder are hidden._ä",
				...
				dataPicError4: "Š_This will add <i>#isImage</i> to the end of unsupported picture URLs. Most server support URL appendages. However, once you have performed that action, you should verify that the updated picture URLs are functional by navigating through your points. If each pictures loads, you can now save the Map Tour. If <b>pictures are broken, don’t save the Map Tour</b>. Instead, reload the builder and perform the second action._ä",
				...
				addNoteVideo: "Š_Consult Help for instructions on using videos_ä",		
				addSelectCaptionNoFileReader: "Š_Select picture_ä",	
				...
				settingsLayoutLocBtnHelp: "Š_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._ä",
			...
			addPopupJS: {
				...
				uploadError2: "Š_Error adding the feature (invalid html tag)_ä",
				...
				errorInvalidPicUrl: "Š_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._ä",
			...
			onlinePhotoSharingCommon: {
				...
				header2: "Š_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._ä",
				...
				advanced: "Š_Advanced options_ä",
				select: "Koosta valik",
				locUse: "Kasuta piltide asukohta",
				locUse2: "Š_Use videos location_ä",
			...
			viewYoutube: {
				header: "Š_Look for publicly shared videos using an user name._ä",
			...
			viewGeoTag: {
				header: "Š_Click or tap the pictures you want to import to locate them._ä",
			...
			initPopupHome: {
				header1: "Š_Where are your medias?_ä",
				...
				title1: "Š_My medias are already hosted_ä",
				title2: "Mul on vaja oma pilte majutada",
				hostedFSTooltip: "Š_Use ArcGIS Online to host your pictures (doesn't support videos)._ä",
				...
				footer5: "Š_Learn about hosting options_ä",
