	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Š_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________ä.",
				noLayerMobile2: "Š_Please rotate your device to landscape orientation to use the Map Tour builder_________________________ä.",
				...
				notAuthorizedBuilder: "Š_You are not authorized to use Map Tour builder_______________ä.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "Š_Loaded %NB_POINTS% points_________ä",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Š_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________ä",
			...
			share: {
				firstSaveTitle: "Š_Tour saved____ä",
				...
				shareLinkHeader: "Š_Share your Tour______ä",
				shareLinkOpen: "AVA",
				shareA1: "Š_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________ä.",
