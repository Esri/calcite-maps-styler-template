	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Š_The Map Tour builder is not supported at this display size___________________ä.",
				noLayerView: "Š_Welcome to the Map Tour web application.<br />The story is not configured yet________________________ä.",
				appSave: "Š_Error saving the story________ä",
			...
			builderHTML: {
				...
				dataEditionDisabled: "Š_Editing data is disabled on this CSV data source_______________ä",
				...
				addMaxPointReached: "Š_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________ä.",
				...
				settingsLayoutExplain: "Š_Select the layout you want_________ä.",
				...
				dataTitle: "Š_Create hosted Map Tour layer_________ä",
				dataExplain: "Š_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________ä.",
				dataExplainPortal: "Š_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________ä.",
				dataNameLbl: "Š_Layer name____ä",
				...
				dataBtnSave: "Š_Create the layer______ä",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "Š_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________ä.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "Š_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________ä.",
				hostedFsNA: "Š_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________ä.",
				hostedFsNA2: "Š_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________ä",
