	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "Š_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________ä",
			...
			initPopupHome: {
				...
				hostedFsNA: "Š_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________ä",
				hostedFsNA2: "Š_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________ä.",
