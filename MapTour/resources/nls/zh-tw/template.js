	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				videos: "影片",
				disabled: "管理員已停用此功能",
				disabledPortal: "試_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________驗",
				header1: "您的圖片必須公開分享。",
			...
			initPopupHome: {
				...
				hostedFsNA: "試_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________驗",
				hostedFsNA2: "試_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________驗.",
