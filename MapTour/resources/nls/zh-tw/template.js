	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "試_The Map Tour builder is not supported at this display size___________________驗.",
				noLayerView: "試_Welcome to the Map Tour web application.<br />The story is not configured yet________________________驗.",
				appSave: "試_Error saving the story________驗",
			...
			builderHTML: {
				...
				dataEditionDisabled: "試_Editing data is disabled on this CSV data source_______________驗",
				...
				addMaxPointReached: "試_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________驗.",
				...
				settingsLayoutExplain: "試_Select the layout you want_________驗.",
				...
				dataTitle: "試_Create hosted Map Tour layer_________驗",
				dataExplain: "試_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________驗.",
				dataExplainPortal: "試_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________驗.",
				dataNameLbl: "試_Layer name____驗",
				...
				dataBtnSave: "試_Create the layer______驗",
			...
			onlinePhotoSharingCommon: {
				...
				videos: "影片",
				disabled: "管理員已停用此功能",
				disabledPortal: "試_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________驗.",
				header1: "您的圖片必須公開分享。",
			...
			initPopupHome: {
				...
				title1: "媒體已上線",
				title2: "我需要上傳我的圖像",
				hostedFSTooltip: "試_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________驗.",
				hostedFsNA: "試_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________驗.",
				hostedFsNA2: "試_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________驗",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "試_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________驗",
