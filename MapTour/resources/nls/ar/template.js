	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "بيت_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________لاحقة.",
				noLayerMobile2: "بيت_Please rotate your device to landscape orientation to use the Map Tour builder_________________________لاحقة.",
				...
				notAuthorizedBuilder: "بيت_You are not authorized to use Map Tour builder_______________لاحقة.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "بيت_Loaded %NB_POINTS% points_________لاحقة",
			...
			initPopupHome: {
				...
				hostedFsNA2: "بيت_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________لاحقة",
			...
			share: {
				firstSaveTitle: "بيت_Tour saved____لاحقة",
				...
				shareLinkHeader: "بيت_Share your Tour______لاحقة",
				shareLinkOpen: "فتح",
				shareA1: "بيت_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________لاحقة.",
