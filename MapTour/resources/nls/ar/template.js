	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "بيت_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________لاحقة",
			...
			initPopupHome: {
				...
				hostedFsNA: "بيت_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________لاحقة",
				hostedFsNA2: "بيت_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________لاحقة.",
