...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "بيت_Start on point no._لاحقة"
			},
			builderHTML: {
				...
				organizeWarning: "بيت_One or multiple points added outside of the interactive builder are hidden._لاحقة",
				...
				dataPicError4: "بيت_This will add <i>#isImage</i> to the end of unsupported picture URLs. Most server support URL appendages. However, once you have performed that action, you should verify that the updated picture URLs are functional by navigating through your points. If each pictures loads, you can now save the Map Tour. If <b>pictures are broken, don’t save the Map Tour</b>. Instead, reload the builder and perform the second action._لاحقة",
				...
				addNoteVideo: "بيت_Consult Help for instructions on using videos_لاحقة",		
				addSelectCaptionNoFileReader: "بيت_Select picture_لاحقة",	
				...
				settingsLayoutLocBtnHelp: "بيت_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._لاحقة",
			...
			addPopupJS: {
				...
				uploadError2: "بيت_Error adding the feature (invalid html tag)_لاحقة",
				notJpg: "يرجى اختيار صورة jpeg للتحميل",
				errorNoPhoto: "اختر الصورة للتحميل",
				errorNoThumbnail: "اختر الصورة المُصغرة للتحميل",
				errorInvalidPicUrl: "بيت_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._لاحقة",
			...
			onlinePhotoSharingCommon: {
				pictures: "بيت_pictures_لاحقة",
				videos: "بيت_videos_لاحقة",
				...
				header2: "بيت_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._لاحقة",
				...
				advanced: "بيت_Advanced options_لاحقة",
				select: "عمل تحديد",
				locUse: "استخدام موقع الصور",
				locUse2: "بيت_Use videos location_لاحقة",
			...
			viewYoutube: {
				header: "بيت_Look for publicly shared videos using an user name._لاحقة",
			...
			viewGeoTag: {
				header: "بيت_Click or tap the pictures you want to import to locate them._لاحقة",
			...
			initPopupHome: {
				header1: "بيت_Where are your medias?_لاحقة",
				...
				title1: "بيت_My medias are already hosted_لاحقة",
				title2: "أحتاج استضافة الصور",
				hostedFSTooltip: "بيت_Use ArcGIS Online to host your pictures (doesn't support videos)._لاحقة",
				...
				footer5: "بيت_Learn about hosting options_لاحقة",
