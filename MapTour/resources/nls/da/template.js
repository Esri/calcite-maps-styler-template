	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "ø_The Map Tour builder is not supported at this display size___________________å.",
				noLayerView: "ø_Welcome to the Map Tour web application.<br />The story is not configured yet________________________å.",
				appSave: "ø_Error saving the story________å",
			...
			builderHTML: {
				...
				dataEditionDisabled: "ø_Editing data is disabled on this CSV data source_______________å",
				...
				addMaxPointReached: "ø_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________å.",
				...
				settingsLayoutExplain: "ø_Select the layout you want_________å.",
				...
				dataTitle: "ø_Create hosted Map Tour layer_________å",
				dataExplain: "ø_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________å.",
				dataExplainPortal: "ø_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________å.",
				dataNameLbl: "ø_Layer name____å",
				...
				dataBtnSave: "ø_Create the layer______å",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "ø_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________å.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "ø_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________å.",
				hostedFsNA: "ø_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________å.",
				hostedFsNA2: "ø_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________å",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "ø_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________å",
