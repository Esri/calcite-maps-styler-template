	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "ø_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________å.",
				noLayerMobile2: "ø_Please rotate your device to landscape orientation to use the Map Tour builder_________________________å.",
				...
				notAuthorizedBuilder: "ø_You are not authorized to use Map Tour builder_______________å.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "ø_Loaded %NB_POINTS% points_________å",
			...
			initPopupHome: {
				...
				hostedFsNA2: "ø_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________å",
			...
			share: {
				firstSaveTitle: "ø_Tour saved____å",
				...
				shareLinkHeader: "ø_Share your Tour______å",
				shareLinkOpen: "ÅBN",
				shareA1: "ø_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________å.",
