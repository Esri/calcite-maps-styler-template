...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "ø_Start on point no._å"
			},
			builderHTML: {
				...
				organizeWarning: "ø_One or multiple points added outside of the interactive builder are hidden._å",
				...
				dataPicError4: "ø_This will add <i>#isImage</i> to the end of unsupported picture URLs. Most server support URL appendages. However, once you have performed that action, you should verify that the updated picture URLs are functional by navigating through your points. If each pictures loads, you can now save the Map Tour. If <b>pictures are broken, don’t save the Map Tour</b>. Instead, reload the builder and perform the second action._å",
				...
				addNoteVideo: "ø_Consult Help for instructions on using videos_å",		
				addSelectCaptionNoFileReader: "ø_Select picture_å",	
				...
				settingsLayoutLocBtnHelp: "ø_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._å",
			...
			addPopupJS: {
				...
				uploadError2: "ø_Error adding the feature (invalid html tag)_å",
				...
				errorInvalidPicUrl: "ø_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._å",
			...
			onlinePhotoSharingCommon: {
				...
				header2: "ø_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._å",
				...
				advanced: "ø_Advanced options_å",
				select: "Foretag en markering",
				locUse: "Brug billedplacering",
				locUse2: "ø_Use videos location_å",
			...
			viewYoutube: {
				header: "ø_Look for publicly shared videos using an user name._å",
				pageInputLbl: "ø_Enter a Youtube user name_å",
				lookupMsgError: "ø_User not found_å",
				howToFind: "ø_How to find a Youtube user name_å",
				howToFind2: "ø_User name is displayed under videos_å",
				found: "ø_Found_å",
				noData: "ø_No public videos found_å"
			},
			viewGeoTag: {
				header: "ø_Click or tap the pictures you want to import to locate them._å",
			...
			initPopupHome: {
				header1: "ø_Where are your medias?_å",
				...
				title1: "ø_My medias are already hosted_å",
				title2: "Jeg skal \"hoste\" mine billeder",
				hostedFSTooltip: "ø_Use ArcGIS Online to host your pictures (doesn't support videos)._å",
				...
				footer5: "ø_Learn about hosting options_å",
