	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Ř_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________ů.",
				noLayerMobile2: "Ř_Please rotate your device to landscape orientation to use the Map Tour builder_________________________ů.",
				...
				notAuthorizedBuilder: "Ř_You are not authorized to use Map Tour builder_______________ů.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "Ř_Loaded %NB_POINTS% points_________ů",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Ř_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________ů",
			...
			share: {
				firstSaveTitle: "Ř_Tour saved____ů",
				...
				shareLinkHeader: "Ř_Share your Tour______ů",
				shareLinkOpen: "OTEVŘENO",
				shareA1: "Ř_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________ů.",
