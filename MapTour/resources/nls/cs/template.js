	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Ř_The Map Tour builder is not supported at this display size___________________ů.",
				noLayerView: "Ř_Welcome to the Map Tour web application.<br />The story is not configured yet________________________ů.",
				appSave: "Ř_Error saving the story________ů",
			...
			builderHTML: {
				...
				dataEditionDisabled: "Ř_Editing data is disabled on this CSV data source_______________ů",
				...
				addMaxPointReached: "Ř_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________ů.",
				...
				settingsLayoutExplain: "Ř_Select the layout you want_________ů.",
				...
				dataTitle: "Ř_Create hosted Map Tour layer_________ů",
				dataExplain: "Ř_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________ů.",
				dataExplainPortal: "Ř_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________ů.",
				dataNameLbl: "Ř_Layer name____ů",
				...
				dataBtnSave: "Ř_Create the layer______ů",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "Ř_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________ů.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "Ř_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________ů.",
				hostedFsNA: "Ř_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________ů.",
				hostedFsNA2: "Ř_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________ů",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "Ř_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________ů",
