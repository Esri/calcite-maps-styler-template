...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "Ř_Start on point no._ů"
			},
			builderHTML: {
				...
				organizeWarning: "Ř_One or multiple points added outside of the interactive builder are hidden._ů",
				...
				dataPicError4: "Ř_This will add <i>#isImage</i> to the end of unsupported picture URLs. Most server support URL appendages. However, once you have performed that action, you should verify that the updated picture URLs are functional by navigating through your points. If each pictures loads, you can now save the Map Tour. If <b>pictures are broken, don’t save the Map Tour</b>. Instead, reload the builder and perform the second action._ů",
				...
				addNoteVideo: "Ř_Consult Help for instructions on using videos_ů",		
				addSelectCaptionNoFileReader: "Ř_Select picture_ů",	
				...
				settingsLayoutLocBtnHelp: "Ř_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._ů",
			...
			addPopupJS: {
				...
				uploadError2: "Ř_Error adding the feature (invalid html tag)_ů",
				...
				errorInvalidPicUrl: "Ř_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._ů",
			...
			onlinePhotoSharingCommon: {
				...
				header2: "Ř_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._ů",
				...
				advanced: "Ř_Advanced options_ů",
				select: "Provést výběr",
				locUse: "Používat umístění obrázků",
				locUse2: "Ř_Use videos location_ů",
			...
			viewYoutube: {
				header: "Ř_Look for publicly shared videos using an user name._ů",
			...
			viewGeoTag: {
				header: "Ř_Click or tap the pictures you want to import to locate them._ů",
			...
			initPopupHome: {
				header1: "Ř_Where are your medias?_ů",
				...
				title1: "Ř_My medias are already hosted_ů",
				title2: "Potřebuji hosting pro své obrázky.",
				hostedFSTooltip: "Ř_Use ArcGIS Online to host your pictures (doesn't support videos)._ů",
				...
				footer5: "Ř_Learn about hosting options_ů",
