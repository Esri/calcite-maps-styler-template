...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "æ_Start on point no._Â"
			},
			builderHTML: {
				...
				organizeWarning: "æ_One or multiple points added outside of the interactive builder are hidden._Â",
				...
				dataPicError4: "æ_This will add <i>#isImage</i> to the end of unsupported picture URLs. Most server support URL appendages. However, once you have performed that action, you should verify that the updated picture URLs are functional by navigating through your points. If each pictures loads, you can now save the Map Tour. If <b>pictures are broken, don’t save the Map Tour</b>. Instead, reload the builder and perform the second action._Â",
				...
				addNoteVideo: "æ_Consult Help for instructions on using videos_Â",		
				addSelectCaptionNoFileReader: "æ_Select picture_Â",	
				...
				settingsLayoutLocBtnHelp: "æ_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._Â",
			...
			addPopupJS: {
				...
				uploadError2: "æ_Error adding the feature (invalid html tag)_Â",
				...
				errorInvalidPicUrl: "æ_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._Â",
			...
			onlinePhotoSharingCommon: {
				...
				header2: "æ_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._Â",
			...
			viewYoutube: {
				header: "æ_Look for publicly shared videos using an user name._Â",
			...
			viewGeoTag: {
				header: "æ_Click or tap the pictures you want to import to locate them._Â",
			...
			initPopupHome: {
				header1: "æ_Where are your medias?_Â",
				...
				title1: "æ_My medias are already hosted_Â",
				title2: "J\'ai besoin d\'héberger mes images",
				hostedFSTooltip: "æ_Use ArcGIS Online to host your pictures (doesn't support videos)._Â",
				...
				footer5: "æ_Learn about hosting options_Â",
