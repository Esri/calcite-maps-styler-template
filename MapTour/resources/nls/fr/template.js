	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "æ_The Map Tour builder is not supported at this display size___________________Â.",
				noLayerView: "æ_Welcome to the Map Tour web application.<br />The story is not configured yet________________________Â.",
				appSave: "æ_Error saving the story________Â",
			...
			builderHTML: {
				...
				dataEditionDisabled: "æ_Editing data is disabled on this CSV data source_______________Â",
				...
				addMaxPointReached: "æ_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________Â.",
				...
				settingsLayoutExplain: "æ_Select the layout you want_________Â.",
				...
				dataTitle: "æ_Create hosted Map Tour layer_________Â",
				dataExplain: "æ_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________Â.",
				dataExplainPortal: "æ_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________Â.",
				dataNameLbl: "æ_Layer name____Â",
				...
				dataBtnSave: "æ_Create the layer______Â",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "æ_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________Â.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "æ_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________Â.",
				hostedFsNA: "æ_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________Â.",
				hostedFsNA2: "æ_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________Â",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "æ_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________Â",
