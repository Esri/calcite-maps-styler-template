...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "æ_Link to current place_Â"
			},
			builderHTML: {
...
Rechargez le générateur et effectuez la seconde action.",
				...
				settingsLayoutLocBtn: "æ_Display a locate button on supported browser_Â",
				...
				dataTitle: "æ_ArcGIS Online hosting_Â",
			...
			builderJS: {
				noPendingChange: "æ_No unsaved change_Â",
			...
			onlinePhotoSharingCommon: {
				...
				header1: "æ_Your pictures must be shared publicly._Â",
				header2: "æ_The import will be limited to the first %NB1% %MEDIA%._Â",
				...
				locUse: "æ_Use pictures geolocation_Â",
			...
			viewPicasa: {
				title: "æ_Picasa/Google+ import_Â",
			...
			viewYoutube: {
				...
				header: "æ_Enter a YouTube user name to find publicly shared videos._Â",
			...
			viewGeoTag: {
				...
				headerMore: "æ_Why aren't my images/videos geolocated?_Â",
				...
				error: "æ_Pictures geolocation import failed, geolocations have been ignored._Â"
			},
			initPopup: {
				title: "æ_Welcome to the Map Tour Builder_Â",
				prevBtn: "Retour",
				nextBtn: "Suivant"
			},
			initPopupHome: {
				header1: "æ_Where are your images or videos?_Â",
				header2: "æ_This assistant will help you build a Map Tour from media already stored online or it will import them into your ArcGIS Online for Organizations account._Â",
				title1: "æ_They are already online_Â",
				title2: "æ_I need to upload my images_Â",
				hostedFSTooltip: "æ_Use ArcGIS Online to host your images (doesn't support videos)._Â",
				hostedFsNA: "æ_Only available for ArcGIS for Organizations Publisher and Administrator users_Â",
				...
				footer4bis: "æ_Use right click and \"Save as\" if download doesn't start_Â",
				footer5: "æ_Learn more_Â",
			...
			helpPopup: {
				...
				tab3: {
					...
					div42: "æ_You build your web map outside of the interactive builder and configure the template with the web map identifier. You will have to read the documentation to learn how to configure the template._Â",
				...
				tab5: {
					...
					div3a: "æ_If you are using a hosted feature service created through the Map Tour builder, the application manages the service security for you and you will remain the only one with editing privileges, even if you share the service publicly._Â",
			...
			share: {
				firstSaveTitle: "æ_Tour successfully saved_Â",
				...
				firstSaveQ2: "æ_Is my Tour shared?_Â",
				firstSaveA2: "æ_Currently your Tour is not shared. To share it, use the SHARE button._Â",
				shareTitle: "æ_Share your Tour_Â",
				sharePrivateHeader: "æ_Your Tour is not shared, would you like to share it?_Â",
				...
				shareHeader1: "æ_Your Tour is <strong>publicly accessible</strong>._Â",
				shareHeader2: "æ_Your Tour is accessible by your organization members (login is required)._Â",
				shareLinkHeader: "æ_Share the Tour with your audience_Â",
				shareLinkOpen: "æ_OPEN_Â",
				shareQ1Opt1: "æ_How do I keep the Tour private?_Â",
				...
				shareA3: "æ_The Tour configuration is stored in <a href='%LINK1%' target='_blank'>this webmap item</a> and <a href='%LINK2%' target='_blank'>this web application item</a>. If you have used Flickr, Picasa, Facebook or YouTube import, your images and videos remains stored there and aren't duplicated in ArcGIS Online._Â"
			}
        }
    })
);
