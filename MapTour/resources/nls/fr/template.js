	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "æ_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________Â.",
				noLayerMobile2: "æ_Please rotate your device to landscape orientation to use the Map Tour builder_________________________Â.",
				...
				notAuthorizedBuilder: "æ_You are not authorized to use Map Tour builder_______________Â.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "æ_Loaded %NB_POINTS% points_________Â",
			...
			initPopupHome: {
				...
				hostedFsNA2: "æ_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________Â",
			...
			share: {
				firstSaveTitle: "æ_Tour saved____Â",
				...
				shareLinkHeader: "æ_Share your Tour______Â",
				shareLinkOpen: "OUVRIR",
				shareA1: "æ_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________Â.",
