	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "æ_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________Â",
			...
			initPopupHome: {
				...
				hostedFsNA: "æ_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________Â",
				hostedFsNA2: "æ_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________Â.",
