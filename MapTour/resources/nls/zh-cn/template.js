...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "试_Start on point no._验"
			},
			builderHTML: {
				panelHeader: "应用程序配置",
				buttonSave: "保存",
				...
				organizeWarning: "试_One or multiple points added outside of the interactive builder are hidden._验",
				...
				dataPicError4: "试_This will add <i>#isImage</i> to the end of unsupported picture URLs. Most server support URL appendages. However, once you have performed that action, you should verify that the updated picture URLs are functional by navigating through your points. If each pictures loads, you can now save the Map Tour. If <b>pictures are broken, don’t save the Map Tour</b>. Instead, reload the builder and perform the second action._验",
				...
				addNoteVideo: "试_Consult Help for instructions on using videos_验",		
				addSelectCaptionNoFileReader: "试_Select picture_验",	
				...
				settingsLayoutLocBtnHelp: "试_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._验",
			...
			addPopupJS: {
				...
				uploadSuccess: "上传成功",
				uploadError: "上传图片出错",
				uploadError2: "试_Error adding the feature (invalid html tag)_验",
				notJpg: "请选择 jpeg 格式的照片",
				errorNoPhoto: "选择要上传的图像",
				errorNoThumbnail: "选择要上传的缩略图",
				errorInvalidPicUrl: "试_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._验",
			...
			onlinePhotoSharingCommon: {
				pictures: "试_pictures_验",
				videos: "试_videos_验",
				disabled: "此功能已被管理员禁用",
				disabledPortal: "Portal for ArcGIS 上禁用此要素",
				header1: "需要公开共享图片。",
				header2: "试_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._验",
				...
				userLookingup: "正在查找",
				csv: "在 CSV 中引用",
				advanced: "试_Advanced options_验",
				select: "做出选择",
				locUse: "使用图片位置",
				locUse2: "试_Use videos location_验",
			...
			viewYoutube: {
				header: "试_Look for publicly shared videos using an user name._验",
			...
			viewGeoTag: {
				header: "试_Click or tap the pictures you want to import to locate them._验",
			...
			initPopupHome: {
				header1: "试_Where are your medias?_验",
				header2: "该助手将帮助您通过已在线存储的图片构建地图浏览，或者将图片导入到您的 ArcGIS Online for Organization 帐户。",
				title1: "试_My medias are already hosted_验",
				title2: "我需要托管我的图片",
				hostedFSTooltip: "试_Use ArcGIS Online to host your pictures (doesn't support videos)._验",
				hostedFsNA: "仅适用于 ArcGIS for Organization 发布者和管理员用户",
				footer1: "完成后，不要忘记通过应用程序项目页面与受众共享您的地图浏览。",
				footer2: "地图浏览帮助",
				footer3: "下载 CSV 模板",
				footer4: "如果不下载，则 \"另存为\"",
				footer5: "试_Learn about hosting options_验",
				footerProgress: "正在创建",
