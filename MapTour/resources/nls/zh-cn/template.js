	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				videos: "视频",
				disabled: "此功能已被管理员禁用",
				disabledPortal: "试_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________验",
				header1: "您的图片必须公开共享。",
			...
			initPopupHome: {
				...
				hostedFsNA: "试_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________验",
				hostedFsNA2: "试_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________验.",
