...
({
		viewer: {
			...
			share: {
				...
				shareQ3: "数据存储位置在哪?",
				shareA3: "试_The Tour configuration is stored in <a href='%LINK1%' target='_blank'>this webmap item</a> and <a href='%LINK2%' target='_blank'>this web application item</a>. Flickr, Picasa, and Facebook images and YouTube videos remain referenced at their respective sites and aren't duplicated in ArcGIS Online._验",
