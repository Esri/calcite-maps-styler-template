	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "试_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________验.",
				noLayerMobile2: "试_Please rotate your device to landscape orientation to use the Map Tour builder_________________________验.",
				noLayerView: "欢迎使用 Map Tour Web 应用程序。<br />尚未配置任何故事。",
				appSave: "保存故事时出错",
				mapSave: "保存 web 地图时出错",
				featureServiceLoad: "加载要素服务时出错",
				notAuthorized: "您无权访问此故事",
				notAuthorizedBuilder: "试_You are not authorized to use Map Tour builder_______________验.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "试_Loaded %NB_POINTS% points_________验",
			...
			initPopupHome: {
				...
				hostedFsNA2: "试_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________验",
			...
			share: {
				firstSaveTitle: "试_Tour saved____验",
				...
				shareLinkHeader: "试_Share your Tour______验",
				shareLinkOpen: "打开",
				shareA1: "试_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________验.",
