		...
		viewer: {
			...
			helpPopup: {
				...
				tab2: {
					...
					div4b: "<b>Las fotos todavía no están alojadas</b> y dispones de una cuenta de ArcGIS for Organizations: el uso de un servicio de entidades alojado es la mejor opción. Al igual que los servicios públicos de uso compartido de fotos, optimizaremos tus imágenes para que se carguen con rapidez y tendrás acceso a todas las funciones de administración y gestión de datos de la plataforma ArcGIS.",
