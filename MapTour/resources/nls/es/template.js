	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "á_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________Ó",
			...
			initPopupHome: {
				...
				hostedFsNA: "á_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________Ó",
				hostedFsNA2: "á_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________Ó.",
