	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "á_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________Ó.",
				noLayerMobile2: "á_Please rotate your device to landscape orientation to use the Map Tour builder_________________________Ó.",
				...
				notAuthorizedBuilder: "á_You are not authorized to use Map Tour builder_______________Ó.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "á_Loaded %NB_POINTS% points_________Ó",
			...
			initPopupHome: {
				...
				hostedFsNA2: "á_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________Ó",
			...
			share: {
				firstSaveTitle: "á_Tour saved____Ó",
				...
				shareLinkHeader: "á_Share your Tour______Ó",
				shareLinkOpen: "ABRIR",
				shareA1: "á_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________Ó.",
