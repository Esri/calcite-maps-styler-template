	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "á_The Map Tour builder is not supported at this display size___________________Ó.",
				noLayerView: "á_Welcome to the Map Tour web application.<br />The story is not configured yet________________________Ó.",
				appSave: "á_Error saving the story________Ó",
			...
			builderHTML: {
				...
				dataEditionDisabled: "á_Editing data is disabled on this CSV data source_______________Ó",
				...
				addMaxPointReached: "á_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________Ó.",
				...
				settingsLayoutExplain: "á_Select the layout you want_________Ó.",
				...
				dataTitle: "á_Create hosted Map Tour layer_________Ó",
				dataExplain: "á_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________Ó.",
				dataExplainPortal: "á_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________Ó.",
				dataNameLbl: "á_Layer name____Ó",
				...
				dataBtnSave: "á_Create the layer______Ó",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "á_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________Ó.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "á_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________Ó.",
				hostedFsNA: "á_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________Ó.",
				hostedFsNA2: "á_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________Ó",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "á_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________Ó",
			...
			locator: {
				error: "á_Location not available________Ó"
			}
        }
    })
);
