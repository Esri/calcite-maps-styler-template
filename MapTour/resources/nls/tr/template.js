	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "ı_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________İ.",
				noLayerMobile2: "ı_Please rotate your device to landscape orientation to use the Map Tour builder_________________________İ.",
				...
				notAuthorizedBuilder: "ı_You are not authorized to use Map Tour builder_______________İ.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "ı_Loaded %NB_POINTS% points_________İ",
			...
			initPopupHome: {
				...
				hostedFsNA2: "ı_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________İ",
			...
			share: {
				firstSaveTitle: "ı_Tour saved____İ",
				...
				shareLinkHeader: "ı_Share your Tour______İ",
				shareLinkOpen: "AÇ",
				shareA1: "ı_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________İ.",
