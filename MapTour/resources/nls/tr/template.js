	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "ı_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________İ",
			...
			initPopupHome: {
				...
				hostedFsNA: "ı_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________İ",
				hostedFsNA2: "ı_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________İ.",
