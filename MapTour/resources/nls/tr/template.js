	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "ı_The Map Tour builder is not supported at this display size___________________İ.",
				noLayerView: "ı_Welcome to the Map Tour web application.<br />The story is not configured yet________________________İ.",
				appSave: "ı_Error saving the story________İ",
			...
			builderHTML: {
				...
				dataEditionDisabled: "ı_Editing data is disabled on this CSV data source_______________İ",
				...
				addMaxPointReached: "ı_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________İ.",
				...
				settingsLayoutExplain: "ı_Select the layout you want_________İ.",
				...
				dataTitle: "ı_Create hosted Map Tour layer_________İ",
				dataExplain: "ı_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________İ.",
				dataExplainPortal: "ı_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________İ.",
				dataNameLbl: "ı_Layer name____İ",
				...
				dataBtnSave: "ı_Create the layer______İ",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "ı_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________İ.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "ı_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________İ.",
				hostedFsNA: "ı_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________İ.",
				hostedFsNA2: "ı_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________İ",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "ı_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________İ",
