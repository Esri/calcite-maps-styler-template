	 ...
	 ({
		viewer: {
			...
			builderHTML: {
				...
				buttonAdd: "Thêm",
				buttonImport: "Nhập",
				buttonImportDisabled: "Nhập không có sẵn khi sử dụng Dịch vụ Đối tượng với tệp đính kèm",
			...
			initPopupHome: {
				...
				hostedFsNA: "Chỉ có sẵn cho người dùng ArcGIS dành cho Tổ chức, Nhà xuất bản và Người quản trị",
			...
			helpPopup: {
				...
				tab2: {
					title: "Dữ liệu",
					div1: "Yếu tố chính cần xem xét khi xây dựng một Map Tour là chọn nơi hình ảnh của bạn sẽ được lưu trữ. Một Map Tour có thể sử dụng hình ảnh được lưu trữ trên các dịch vụ chia sẻ hình ảnh lớn, trên bất kỳ máy chủ web hoặc theo tệp đính kèm một dịch vụ đối tượng.",
					...
					div13: "Có thể sử dụng bất kỳ dịch vụ đối tượng điểm hoặc shapefile nào để làm nguồn dữ liệu Map Tour. Bạn chỉ cần thêm nó như là một lớp vào bản đồ web của bạn thông qua Trình xem Bản đồ arcgis.com. Nếu ứng dụng phát hiện các thuộc tính dự kiến ​​trong lớp của bạn, tất cả các chức năng bộ dựng sẽ có sẵn.",
				...
				tab3: {
					...
					div43: "Lưu ý rằng bộ dựng tương tác có sẵn trong phiên bản có thể tải về nhưng có một số hạn chế về kỹ thuật trên các trình duyệt như Internet Explorer cũ hơn phiên bản 10.",
