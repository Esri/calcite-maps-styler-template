...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "כן_Start on point no._ש"
			},
			builderHTML: {
				...
				organizeWarning: "כן_One or multiple points added outside of the interactive builder are hidden._ש",
				...
				addNoteVideo: "כן_Consult Help for instructions on using videos_ש",		
				addSelectCaptionNoFileReader: "כן_Select picture_ש",	
				...
				settingsLayoutLocBtnHelp: "כן_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._ש",
			...
			addPopupJS: {
				...
				uploadError2: "כן_Error adding the feature (invalid html tag)_ש",
				notJpg: "אנא בחר את תמונת ה- jpeg לטעינה",
				errorNoPhoto: "בחר תמונה להעלות",
				errorNoThumbnail: "בחר תמונה ממוזערת להעלות",
				errorInvalidPicUrl: "כן_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._ש",
			...
			onlinePhotoSharingCommon: {
				...
				header2: "כן_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._ש",
				...
				csv: "מקושר ל- CSV",
				advanced: "כן_Advanced options_ש",
				select: "בצע בחירה",
				locUse: "השתמש במיקום תמונות",
				locUse2: "כן_Use videos location_ש",
			...
			viewYoutube: {
				header: "כן_Look for publicly shared videos using an user name._ש",
			...
			viewGeoTag: {
				header: "כן_Click or tap the pictures you want to import to locate them._ש",
			...
			initPopupHome: {
				header1: "כן_Where are your medias?_ש",
				...
				title1: "כן_My medias are already hosted_ש",
				title2: "אני צריך לארח את התמונות שלי",
				hostedFSTooltip: "כן_Use ArcGIS Online to host your pictures (doesn't support videos)._ש",
				...
				footer5: "כן_Learn about hosting options_ש",
