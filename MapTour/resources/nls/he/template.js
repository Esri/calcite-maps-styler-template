	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "כן_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________ש.",
				noLayerMobile2: "כן_Please rotate your device to landscape orientation to use the Map Tour builder_________________________ש.",
				...
				notAuthorizedBuilder: "כן_You are not authorized to use Map Tour builder_______________ש.",
			...
			builderHTML: {
				...
				dataExplain: "כן_A new Feature Layer will be created for your images and tour points. The tour layer won't be shared with anyone unless you share your Map Tour____________________________________________ש.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "כן_Loaded %NB_POINTS% points_________ש",
			...
			initPopupHome: {
				...
				hostedFsNA2: "כן_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________ש",
			...
			share: {
				firstSaveTitle: "כן_Tour saved____ש",
				...
				shareLinkHeader: "כן_Share your Tour______ש",
				shareLinkOpen: "פתח",
				shareA1: "כן_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________ש.",
