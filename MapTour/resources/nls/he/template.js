	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "כן_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________ש",
			...
			initPopupHome: {
				...
				hostedFsNA: "כן_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________ש",
				hostedFsNA2: "כן_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________ש.",
