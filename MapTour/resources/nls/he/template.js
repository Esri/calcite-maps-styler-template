	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "כן_The Map Tour builder is not supported at this display size___________________ש.",
				noLayerView: "כן_Welcome to the Map Tour web application.<br />The story is not configured yet________________________ש.",
				appSave: "כן_Error saving the story________ש",
			...
			builderHTML: {
				...
				dataEditionDisabled: "כן_Editing data is disabled on this CSV data source_______________ש",
				...
				addMaxPointReached: "כן_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________ש.",
				...
				settingsLayoutExplain: "כן_Select the layout you want_________ש.",
				...
				dataTitle: "כן_Create hosted Map Tour layer_________ש",
				...
				dataExplainPortal: "כן_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________ש.",
				dataNameLbl: "כן_Layer name____ש",
				...
				dataBtnSave: "כן_Create the layer______ש",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "כן_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________ש.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "כן_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________ש.",
				hostedFsNA: "כן_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________ש.",
				hostedFsNA2: "כן_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________ש",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "כן_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________ש",
