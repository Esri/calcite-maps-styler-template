		...
		viewer: {
			...
			helpPopup: {
				...
				tab3: {
					...
					div5: "Odwiedź <a href='https://github.com/Esri/map-tour-storytelling-template-js' target='_blank'>stronę projektu GitHub</a>, aby pobrać najnowszą wersję szablonu i dowiedzieć się więcej na temat sposobu jego użytkowania."
				},
				tab4: {
					title: "Wskazówki",
					...
					div12: "Należy unikać korzystania z elementu iFrame o niewielkiej szerokości, ponieważ spowoduje on przełączenie się mapy wycieczki do interaktywnego układu dotykowego dla małych ekranów. Aby zmaksymalizować łatwość użytkowania, po osadzeniu mapy wycieczki najlepiej nadal podawać obok niej odnośnik, dzięki czemu użytkownicy będą mogli uruchomić mapę wycieczki na pełnym ekranie." 
				},
				tab5: {
					title: "Publikowanie",
					...
					div3: "Upewnij się, że wycieczka działa poprawnie bez konieczności logowania się do konta ArcGIS.com. Adres URL, który będzie używany, nie powinien przekierowywać do strony logowania ani do trybu konfiguratora.",
					...
					div5b: "Aby pomóc osobom wykonującym wyszukiwania na platformie ArcGIS Online w znalezieniu mapy wycieczki, zalecamy dodanie znacznika \"mapa z historią\" na stronie elementu aplikacji mapy wycieczki (nie zaś na stronie elementu mapy internetowej), a także znaczników zawierających nazwę stanu, regionu lub prowincji, w której znajduje wycieczka, nazwa kraju (jeśli jest ona położona poza USA) oraz znaczników tematycznych, takich jak \"sztuka publiczna"\, \"przewodnik turystyczny\", czy \"miejsca historyczne\". Znaczniki te również pomagają pracownikom firmy Esri w znajdowaniu nowych, ciekawych przykładów wycieczek do zaprezentowania w galeriach oraz promowania w mediach społecznościowych. Najlepiej przesyłać także ładnie wyglądające miniatury na swoją stronę elementu aplikacji, takie jak miniatury zrzutów ekranu wycieczki lub jedno ze zdjęć w niej umieszczonych. Obraz ten zostanie automatycznie użyty, jeśli mapa wycieczki zostanie dodana do galerii platformy ArcGIS Online."
				}
			},
			share: {
				...
				firstSaveA1bis: "Wycieczkę będzie również znajdować się w <a href='%LINK2%' target='_blank'> folderze zasobów w serwisie ArcGIS Online</a> użytkownika.",
				...
				shareA2div1: "Zapisz i skorzystaj ponownie z następującego linku %LINK1% lub użyj <a href='%LINK2%' target='_blank'>strony elementu aplikacji</a>.",
