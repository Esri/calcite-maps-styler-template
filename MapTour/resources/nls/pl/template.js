	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "ł_The Map Tour builder is not supported at this display size___________________ą.",
				noLayerView: "ł_Welcome to the Map Tour web application.<br />The story is not configured yet________________________ą.",
				appSave: "ł_Error saving the story________ą",
			...
			builderHTML: {
				...
				dataEditionDisabled: "ł_Editing data is disabled on this CSV data source_______________ą",
				...
				addMaxPointReached: "ł_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________ą.",
				...
				settingsLayoutExplain: "ł_Select the layout you want_________ą.",
				...
				dataTitle: "ł_Create hosted Map Tour layer_________ą",
				dataExplain: "ł_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________ą.",
				dataExplainPortal: "ł_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________ą.",
				dataNameLbl: "ł_Layer name____ą",
				...
				dataBtnSave: "ł_Create the layer______ą",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "ł_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________ą.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "ł_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________ą.",
				hostedFsNA: "ł_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________ą.",
				hostedFsNA2: "ł_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________ą",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "ł_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________ą",
			...
			locator: {
				error: "ł_Location not available________ą"
			}
        }
    })
);
