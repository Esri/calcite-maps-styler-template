	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "ł_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________ą.",
				noLayerMobile2: "ł_Please rotate your device to landscape orientation to use the Map Tour builder_________________________ą.",
				...
				notAuthorizedBuilder: "ł_You are not authorized to use Map Tour builder_______________ą.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "ł_Loaded %NB_POINTS% points_________ą",
			...
			initPopupHome: {
				...
				hostedFsNA2: "ł_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________ą",
			...
			share: {
				firstSaveTitle: "ł_Tour saved____ą",
				...
				shareLinkHeader: "ł_Share your Tour______ą",
				shareLinkOpen: "OTWÓRZ",
				shareA1: "ł_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________ą.",
