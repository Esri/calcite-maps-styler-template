	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "ł_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________ą",
			...
			initPopupHome: {
				...
				hostedFsNA: "ł_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________ą",
				hostedFsNA2: "ł_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________ą.",
