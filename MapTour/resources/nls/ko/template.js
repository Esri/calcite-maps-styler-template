	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "한_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________빠.",
				noLayerMobile2: "한_Please rotate your device to landscape orientation to use the Map Tour builder_________________________빠.",
				...
				notAuthorizedBuilder: "한_You are not authorized to use Map Tour builder_______________빠.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "한_Loaded %NB_POINTS% points_________빠",
			...
			initPopupHome: {
				...
				hostedFsNA2: "한_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________빠",
			...
			share: {
				firstSaveTitle: "한_Tour saved____빠",
				...
				shareLinkHeader: "한_Share your Tour______빠",
				shareLinkOpen: "열기",
				shareA1: "한_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________빠.",
