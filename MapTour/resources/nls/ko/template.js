	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "한_The Map Tour builder is not supported at this display size___________________빠.",
				noLayerView: "한_Welcome to the Map Tour web application.<br />The story is not configured yet________________________빠.",
				appSave: "한_Error saving the story________빠",
			...
			builderHTML: {
				...
				dataEditionDisabled: "한_Editing data is disabled on this CSV data source_______________빠",
				...
				addMaxPointReached: "한_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________빠.",
				...
				settingsLayoutExplain: "한_Select the layout you want_________빠.",
				...
				dataTitle: "한_Create hosted Map Tour layer_________빠",
				dataExplain: "한_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________빠.",
				dataExplainPortal: "한_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________빠.",
				dataNameLbl: "한_Layer name____빠",
				...
				dataBtnSave: "한_Create the layer______빠",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "한_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________빠.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "한_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________빠.",
				hostedFsNA: "한_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________빠.",
				hostedFsNA2: "한_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________빠",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "한_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________빠",
			...
			locator: {
				error: "한_Location not available________빠"
			}
        }
    })
);
