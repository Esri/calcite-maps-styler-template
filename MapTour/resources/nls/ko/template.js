...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "한_Start on point no._빠"
			},
			builderHTML: {
				...
				organizeWarning: "한_One or multiple points added outside of the interactive builder are hidden._빠",
				...
				dataPicError4: "한_This will add <i>#isImage</i> to the end of unsupported picture URLs. Most server support URL appendages. However, once you have performed that action, you should verify that the updated picture URLs are functional by navigating through your points. If each pictures loads, you can now save the Map Tour. If <b>pictures are broken, don’t save the Map Tour</b>. Instead, reload the builder and perform the second action._빠",
				...
				addNoteVideo: "한_Consult Help for instructions on using videos_빠",		
				addSelectCaptionNoFileReader: "한_Select picture_빠",	
				...
				settingsLayoutLocBtnHelp: "한_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._빠",
			...
			addPopupJS: {
				...
				uploadError2: "한_Error adding the feature (invalid html tag)_빠",
				notJpg: "업로드할 jpeg 사진을 선택하세요.",
				errorNoPhoto: "업로드할 이미지를 선택하세요.",
				errorNoThumbnail: "업로드할 미리보기를 선택하세요.",
				errorInvalidPicUrl: "한_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._빠",
			...
			onlinePhotoSharingCommon: {
				pictures: "한_pictures_빠",
				videos: "한_videos_빠",
				disabled: "이 기능은 관리자가 사용하지 않도록 설정했습니다.",
				disabledPortal: "이 기능은 Portal for ArcGIS에서 사용하지 않도록 설정되었습니다.",
				header1: "그림을 공개적으로 공유해야 합니다.",
				header2: "한_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._빠",
				...
				userLookingup: "조회 중",
				csv: "CSV에서 참조됨",
				advanced: "한_Advanced options_빠",
				select: "선택",
				locUse: "그림 위치 사용",
				locUse2: "한_Use videos location_빠",
			...
			viewYoutube: {
				header: "한_Look for publicly shared videos using an user name._빠",
				pageInputLbl: "한_Enter a Youtube user name_빠",
				lookupMsgError: "한_User not found_빠",
				howToFind: "한_How to find a Youtube user name_빠",
				howToFind2: "한_User name is displayed under videos_빠",
				found: "한_Found_빠",
				noData: "한_No public videos found_빠"
			},
			viewGeoTag: {
				header: "한_Click or tap the pictures you want to import to locate them._빠",
			...
			initPopupHome: {
				header1: "한_Where are your medias?_빠",
				header2: "이 도우미는 온라인으로 이미 저장된 그림에서 Map Tour를 생성하도록 도와주거나, ArcGIS Online for Organization 계정으로 Map Tour를 가져옵니다.",
				title1: "한_My medias are already hosted_빠",
				title2: "호스팅해야 함",
				hostedFSTooltip: "한_Use ArcGIS Online to host your pictures (doesn't support videos)._빠",
				...
				footer5: "한_Learn about hosting options_빠",
				footerProgress: "생성 중",
