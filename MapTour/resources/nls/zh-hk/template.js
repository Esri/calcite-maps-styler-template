	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "試_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________驗.",
				noLayerMobile2: "試_Please rotate your device to landscape orientation to use the Map Tour builder_________________________驗.",
				noLayerView: "歡迎使用 Map Tour Web 應用程式。<br />尚未設定該故事。",
				appSave: "儲存故事時出錯",
				mapSave: "儲存 web 地圖時出錯",
				featureServiceLoad: "載入圖徵服務時出錯",
				notAuthorized: "您未取得存取該故事的授權",
				notAuthorizedBuilder: "試_You are not authorized to use Map Tour builder_______________驗.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "試_Loaded %NB_POINTS% points_________驗",
			...
			initPopupHome: {
				...
				hostedFsNA2: "試_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________驗",
			...
			share: {
				firstSaveTitle: "試_Tour saved____驗",
				...
				shareLinkHeader: "試_Share your Tour______驗",
				shareLinkOpen: "打開",
				shareA1: "試_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________驗.",
