	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "Ĳ_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________ä",
			...
			initPopupHome: {
				...
				hostedFsNA: "Ĳ_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________ä",
				hostedFsNA2: "Ĳ_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________ä.",
