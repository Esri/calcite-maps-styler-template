	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Ă_The Map Tour builder is not supported at this display size___________________ș.",
				noLayerView: "Ă_Welcome to the Map Tour web application.<br />The story is not configured yet________________________ș.",
				appSave: "Ă_Error saving the story________ș",
			...
			builderHTML: {
				...
				dataEditionDisabled: "Ă_Editing data is disabled on this CSV data source_______________ș",
				...
				addMaxPointReached: "Ă_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________ș.",
				...
				settingsLayoutExplain: "Ă_Select the layout you want_________ș.",
				...
				dataTitle: "Ă_Create hosted Map Tour layer_________ș",
				dataExplain: "Ă_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________ș.",
				dataExplainPortal: "Ă_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________ș.",
				dataNameLbl: "Ă_Layer name____ș",
				...
				dataBtnSave: "Ă_Create the layer______ș",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "Ă_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________ș.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "Ă_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________ș.",
				hostedFsNA: "Ă_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________ș.",
				hostedFsNA2: "Ă_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________ș",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "Ă_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________ș",
			...
			locator: {
				error: "Ă_Location not available________ș"
			}
        }
    })
);
