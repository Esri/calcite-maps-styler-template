...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "Ă_Start on point no._ș"
			},
			builderHTML: {
				...
				organizeWarning: "Ă_One or multiple points added outside of the interactive builder are hidden._ș",
				...
				dataPicError4: "Ă_This will add <i>#isImage</i> to the end of unsupported picture URLs. Most server support URL appendages. However, once you have performed that action, you should verify that the updated picture URLs are functional by navigating through your points. If each pictures loads, you can now save the Map Tour. If <b>pictures are broken, don’t save the Map Tour</b>. Instead, reload the builder and perform the second action._ș",
				...
				addNoteVideo: "Ă_Consult Help for instructions on using videos_ș",		
				addSelectCaptionNoFileReader: "Ă_Select picture_ș",	
				...
				settingsLayoutLocBtnHelp: "Ă_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._ș",
			...
			addPopupJS: {
				...
				uploadError2: "Ă_Error adding the feature (invalid html tag)_ș",
				...
				errorInvalidPicUrl: "Ă_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._ș",
			...
			onlinePhotoSharingCommon: {
				...
				header2: "Ă_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._ș",
				...
				advanced: "Ă_Advanced options_ș",
				select: "Efectuare selecţie",
				locUse: "Utilizare locaţie imagini",
				locUse2: "Ă_Use videos location_ș",
			...
			viewYoutube: {
				header: "Ă_Look for publicly shared videos using an user name._ș",
			...
			viewGeoTag: {
				header: "Ă_Click or tap the pictures you want to import to locate them._ș",
			...
			initPopupHome: {
				header1: "Ă_Where are your medias?_ș",
				...
				title1: "Ă_My medias are already hosted_ș",
				title2: "Am nevoie să îmi găzduiesc fotografiile",
				hostedFSTooltip: "Ă_Use ArcGIS Online to host your pictures (doesn't support videos)._ș",
				...
				footer5: "Ă_Learn about hosting options_ș",
