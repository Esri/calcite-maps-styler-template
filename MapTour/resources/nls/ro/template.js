	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "Ă_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________ș",
			...
			initPopupHome: {
				...
				hostedFsNA: "Ă_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________ș",
				hostedFsNA2: "Ă_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________ș.",
