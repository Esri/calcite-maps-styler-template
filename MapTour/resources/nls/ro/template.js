	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Ă_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________ș.",
				noLayerMobile2: "Ă_Please rotate your device to landscape orientation to use the Map Tour builder_________________________ș.",
				...
				notAuthorizedBuilder: "Ă_You are not authorized to use Map Tour builder_______________ș.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "Ă_Loaded %NB_POINTS% points_________ș",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Ă_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________ș",
			...
			share: {
				firstSaveTitle: "Ă_Tour saved____ș",
				...
				shareLinkHeader: "Ă_Share your Tour______ș",
				shareLinkOpen: "DESCHIDERE",
				shareA1: "Ă_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________ș.",
