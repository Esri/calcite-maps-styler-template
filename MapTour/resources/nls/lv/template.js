	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "ķ_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________ū",
			...
			initPopupHome: {
				...
				hostedFsNA: "ķ_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________ū",
				hostedFsNA2: "ķ_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________ū.",
