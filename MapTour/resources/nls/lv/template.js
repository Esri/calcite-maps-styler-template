	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "ķ_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________ū.",
				noLayerMobile2: "ķ_Please rotate your device to landscape orientation to use the Map Tour builder_________________________ū.",
				...
				notAuthorizedBuilder: "ķ_You are not authorized to use Map Tour builder_______________ū.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "ķ_Loaded %NB_POINTS% points_________ū",
			...
			initPopupHome: {
				...
				hostedFsNA2: "ķ_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________ū",
			...
			share: {
				firstSaveTitle: "ķ_Tour saved____ū",
				...
				shareLinkHeader: "ķ_Share your Tour______ū",
				shareLinkOpen: "ATVĒRTS",
				shareA1: "ķ_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________ū.",
