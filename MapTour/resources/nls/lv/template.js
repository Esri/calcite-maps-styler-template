...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "ķ_Start on point no._ū"
			},
			builderHTML: {
				...
				organizeWarning: "ķ_One or multiple points added outside of the interactive builder are hidden._ū",
				...
				dataPicError4: "ķ_This will add <i>#isImage</i> to the end of unsupported picture URLs. Most server support URL appendages. However, once you have performed that action, you should verify that the updated picture URLs are functional by navigating through your points. If each pictures loads, you can now save the Map Tour. If <b>pictures are broken, don’t save the Map Tour</b>. Instead, reload the builder and perform the second action._ū",
				...
				addNoteVideo: "ķ_Consult Help for instructions on using videos_ū",		
				addSelectCaptionNoFileReader: "ķ_Select picture_ū",	
				...
				settingsLayoutLocBtnHelp: "ķ_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._ū",
			...
			addPopupJS: {
				...
				uploadError2: "ķ_Error adding the feature (invalid html tag)_ū",
				...
				errorInvalidPicUrl: "ķ_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._ū",
			...
			onlinePhotoSharingCommon: {
				...
				header2: "ķ_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._ū",
				...
				csv: "Atsauce uz CSV",
				advanced: "ķ_Advanced options_ū",
				select: "Veikt izvēli",
				locUse: "Lietot bilžu izvietojumu",
				locUse2: "ķ_Use videos location_ū",
			...
			viewYoutube: {
				header: "ķ_Look for publicly shared videos using an user name._ū",
			...
			viewGeoTag: {
				header: "ķ_Click or tap the pictures you want to import to locate them._ū",
			...
			initPopupHome: {
				header1: "ķ_Where are your medias?_ū",
				...
				title1: "ķ_My medias are already hosted_ū",
				title2: "Man vajag hostēt manas bildes",
				hostedFSTooltip: "ķ_Use ArcGIS Online to host your pictures (doesn't support videos)._ū",
				...
				footer5: "ķ_Learn about hosting options_ū",
