	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "ķ_The Map Tour builder is not supported at this display size___________________ū.",
				noLayerView: "ķ_Welcome to the Map Tour web application.<br />The story is not configured yet________________________ū.",
				appSave: "ķ_Error saving the story________ū",
			...
			builderHTML: {
				...
				dataEditionDisabled: "ķ_Editing data is disabled on this CSV data source_______________ū",
				...
				addMaxPointReached: "ķ_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________ū.",
				...
				settingsLayoutExplain: "ķ_Select the layout you want_________ū.",
				...
				dataTitle: "ķ_Create hosted Map Tour layer_________ū",
				dataExplain: "ķ_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________ū.",
				dataExplainPortal: "ķ_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________ū.",
				dataNameLbl: "ķ_Layer name____ū",
				...
				dataBtnSave: "ķ_Create the layer______ū",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "ķ_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________ū.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "ķ_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________ū.",
				hostedFsNA: "ķ_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________ū.",
				hostedFsNA2: "ķ_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________ū",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "ķ_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________ū",
			...
			locator: {
				error: "ķ_Location not available________ū"
			}
        }
    })
);
