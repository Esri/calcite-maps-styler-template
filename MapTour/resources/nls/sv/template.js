	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Å_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________ö.",
				noLayerMobile2: "Å_Please rotate your device to landscape orientation to use the Map Tour builder_________________________ö.",
				...
				notAuthorizedBuilder: "Å_You are not authorized to use Map Tour builder_______________ö.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "Å_Loaded %NB_POINTS% points_________ö",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Å_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________ö",
			...
			share: {
				firstSaveTitle: "Å_Tour saved____ö",
				...
				shareLinkHeader: "Å_Share your Tour______ö",
				shareLinkOpen: "ÖPPNA",
				shareA1: "Å_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________ö.",
