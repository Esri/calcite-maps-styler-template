	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "Å_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________ö",
			...
			initPopupHome: {
				...
				hostedFsNA: "Å_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________ö",
				hostedFsNA2: "Å_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________ö.",
