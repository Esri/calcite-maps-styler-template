		...
		viewer: {
			...
			helpPopup: {
				...
				tab2: {
					...
					div3: "<ul><li>Du kan använda <b>bilder som redan finns online</b>, till exempel bilder som lagras på en fotodelningswebbplats som Flickr, eller på din egen webbplats. De refereras i kartturen via webbadresserna till dem</li><li>Du kan även <b>överföra bilder från datorn</b> direkt till kartturen. Det kräver att du har ett ArcGIS for Organisations-konto och utgivar- eller administratörsbehörighet eftersom det automatiskt skapas en driftad geoobjekttjänst där bilderna lagras som bilagor.</li></ul>",
