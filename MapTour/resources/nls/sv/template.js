	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Å_The Map Tour builder is not supported at this display size___________________ö.",
				noLayerView: "Å_Welcome to the Map Tour web application.<br />The story is not configured yet________________________ö.",
				appSave: "Å_Error saving the story________ö",
			...
			builderHTML: {
				...
				dataEditionDisabled: "Å_Editing data is disabled on this CSV data source_______________ö",
				...
				addMaxPointReached: "Å_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________ö.",
				...
				settingsLayoutExplain: "Å_Select the layout you want_________ö.",
				...
				dataTitle: "Å_Create hosted Map Tour layer_________ö",
				dataExplain: "Å_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________ö.",
				dataExplainPortal: "Å_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________ö.",
				dataNameLbl: "Å_Layer name____ö",
				...
				dataBtnSave: "Å_Create the layer______ö",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "Å_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________ö.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "Å_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________ö.",
				hostedFsNA: "Å_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________ö.",
				hostedFsNA2: "Å_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________ö",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "Å_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________ö",
