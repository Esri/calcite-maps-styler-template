	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "é_The Map Tour builder is not supported at this display size___________________È.",
				noLayerView: "é_Welcome to the Map Tour web application.<br />The story is not configured yet________________________È.",
				appSave: "é_Error saving the story________È",
			...
			builderHTML: {
				...
				dataEditionDisabled: "é_Editing data is disabled on this CSV data source_______________È",
				...
				addMaxPointReached: "é_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________È.",
				...
				settingsLayoutExplain: "é_Select the layout you want_________È.",
				...
				dataTitle: "é_Create hosted Map Tour layer_________È",
				dataExplain: "é_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________È.",
				dataExplainPortal: "é_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________È.",
				dataNameLbl: "é_Layer name____È",
				...
				dataBtnSave: "é_Create the layer______È",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "é_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________È.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "é_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________È.",
				hostedFsNA: "é_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________È.",
				hostedFsNA2: "é_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________È",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "é_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________È",
			...
			locator: {
				error: "é_Location not available________È"
			}
        }
    })
);
