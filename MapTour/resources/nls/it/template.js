...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "é_Start on point no._È"
			},
			builderHTML: {
				...
				organizeWarning: "é_One or multiple points added outside of the interactive builder are hidden._È",
				...
				dataPicError4: "é_This will add <i>#isImage</i> to the end of unsupported picture URLs. Most server support URL appendages. However, once you have performed that action, you should verify that the updated picture URLs are functional by navigating through your points. If each pictures loads, you can now save the Map Tour. If <b>pictures are broken, don’t save the Map Tour</b>. Instead, reload the builder and perform the second action._È",
				...
				addNoteVideo: "é_Consult Help for instructions on using videos_È",		
				addSelectCaptionNoFileReader: "é_Select picture_È",	
				...
				settingsLayoutLocBtnHelp: "é_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._È",
			...
			addPopupJS: {
				...
				uploadError2: "é_Error adding the feature (invalid html tag)_È",
				...
				errorInvalidPicUrl: "é_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._È",
			...
			onlinePhotoSharingCommon: {
				...
				header2: "é_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._È",
				...
				advanced: "é_Advanced options_È",
				select: "Crea una selezione",
				locUse: "Usa posizione immagini",
				locUse2: "é_Use videos location_È",
			...
			viewYoutube: {
				header: "é_Look for publicly shared videos using an user name._È",
			...
			viewGeoTag: {
				header: "é_Click or tap the pictures you want to import to locate them._È",
			...
			initPopupHome: {
				header1: "é_Where are your medias?_È",
				...
				title1: "é_My medias are already hosted_È",
				title2: "Devo ospitare le mie immagini",
				hostedFSTooltip: "é_Use ArcGIS Online to host your pictures (doesn't support videos)._È",
				...
				footer5: "é_Learn about hosting options_È",
