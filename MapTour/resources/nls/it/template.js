	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "é_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________È",
			...
			initPopupHome: {
				...
				hostedFsNA: "é_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________È",
				hostedFsNA2: "é_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________È.",
