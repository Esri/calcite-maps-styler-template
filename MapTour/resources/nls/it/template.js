	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "é_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________È.",
				noLayerMobile2: "é_Please rotate your device to landscape orientation to use the Map Tour builder_________________________È.",
				...
				notAuthorizedBuilder: "é_You are not authorized to use Map Tour builder_______________È.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "é_Loaded %NB_POINTS% points_________È",
			...
			initPopupHome: {
				...
				hostedFsNA2: "é_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________È",
			...
			share: {
				firstSaveTitle: "é_Tour saved____È",
				...
				shareLinkHeader: "é_Share your Tour______È",
				shareLinkOpen: "APRI",
				shareA1: "é_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________È.",
