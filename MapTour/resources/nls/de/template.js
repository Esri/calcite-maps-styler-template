	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "ä_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________Ü.",
				noLayerMobile2: "ä_Please rotate your device to landscape orientation to use the Map Tour builder_________________________Ü.",
				...
				notAuthorizedBuilder: "ä_You are not authorized to use Map Tour builder_______________Ü.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "ä_Loaded %NB_POINTS% points_________Ü",
			...
			initPopupHome: {
				...
				hostedFsNA2: "ä_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________Ü",
			...
			share: {
				firstSaveTitle: "ä_Tour saved____Ü",
				...
				shareLinkHeader: "ä_Share your Tour______Ü",
				shareLinkOpen: "ÖFFNEN",
				shareA1: "ä_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________Ü.",
