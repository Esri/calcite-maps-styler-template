	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "ä_The Map Tour builder is not supported at this display size___________________Ü.",
				noLayerView: "ä_Welcome to the Map Tour web application.<br />The story is not configured yet________________________Ü.",
				appSave: "ä_Error saving the story________Ü",
			...
			builderHTML: {
				...
				dataEditionDisabled: "ä_Editing data is disabled on this CSV data source_______________Ü",
				...
				addMaxPointReached: "ä_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________Ü.",
				...
				dataTitle: "ä_Create hosted Map Tour layer_________Ü",
				dataExplain: "ä_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________Ü.",
				dataExplainPortal: "ä_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________Ü.",
				dataNameLbl: "ä_Layer name____Ü",
				...
				dataBtnSave: "ä_Create the layer______Ü",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "ä_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________Ü.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "ä_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________Ü.",
				hostedFsNA: "ä_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________Ü.",
				hostedFsNA2: "ä_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________Ü",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "ä_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________Ü",
