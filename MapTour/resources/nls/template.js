	...
	root: ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "This feature require the Portal to have an ArcGIS Data Store configured as the managed Database",
			...
			initPopupHome: {
				...
				hostedFsNA: "Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>",
				hostedFsNA2: "This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator.",
