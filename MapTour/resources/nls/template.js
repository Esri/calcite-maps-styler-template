	...
	root: ({
		viewer: {
			...
			share: {
				...
				firstSaveHeader: "Your Tour is now saved. Please read the following answers to frequent questions.",
				firstSaveA1: "The Tour can be found in <a href='%LINK2%' target='_blank'>My Content</a>, or you can bookmark the app in your browser. If you are signed in when you view the Tour you will see a button to Switch to Builder Mode.",
				firstSaveQ2: "Is my Tour shared?",
				firstSaveA2: "Your Tour is not currently shared with anyone. To share it, use the SHARE button.",
				...
				shareA2div2: "As the owner of the application, when you are signed in, the application includes a button to open the interactive builder:",				
				shareQ3: "Where is the data stored?",
				shareA3: "The Tour configuration is stored in <a href='%LINK1%' target='_blank'>this webmap item</a> and <a href='%LINK2%' target='_blank'>this web application item</a>. Flickr, Picasa, and Facebook images and YouTube videos remain referenced at their respective sites and aren't duplicated in ArcGIS.",
