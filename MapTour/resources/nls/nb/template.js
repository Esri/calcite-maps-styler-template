...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "å_Start on point no._ø"
			},
			builderHTML: {
				...
				organizeWarning: "å_One or multiple points added outside of the interactive builder are hidden._ø",
				...
				addNoteVideo: "å_Consult Help for instructions on using videos_ø",		
				addSelectCaptionNoFileReader: "å_Select picture_ø",	
				...
				settingsLayoutLocBtnHelp: "å_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._ø",
			...
			addPopupJS: {
				...
				uploadError2: "å_Error adding the feature (invalid html tag)_ø",
				...
				errorInvalidPicUrl: "å_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._ø",
			...
			onlinePhotoSharingCommon: {
				...
				header2: "å_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._ø",
				...
				advanced: "å_Advanced options_ø",
				select: "Foreta et valg",
				locUse: "Bruk bildeplasseringen",
				locUse2: "å_Use videos location_ø",
			...
			viewYoutube: {
				header: "å_Look for publicly shared videos using an user name._ø",
				pageInputLbl: "å_Enter a Youtube user name_ø",
				lookupMsgError: "å_User not found_ø",
				howToFind: "å_How to find a Youtube user name_ø",
				howToFind2: "å_User name is displayed under videos_ø",
				found: "å_Found_ø",
				noData: "å_No public videos found_ø"
			},
			viewGeoTag: {
				header: "å_Click or tap the pictures you want to import to locate them._ø",
			...
			initPopupHome: {
				header1: "å_Where are your medias?_ø",
				...
				title1: "å_My medias are already hosted_ø",
				title2: "Jeg trenger en vertsserver til bildene mine",
				hostedFSTooltip: "å_Use ArcGIS Online to host your pictures (doesn't support videos)._ø",
				...
				footer5: "å_Learn about hosting options_ø",
