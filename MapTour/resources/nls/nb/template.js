	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "å_The Map Tour builder is not supported at this display size___________________ø.",
				noLayerView: "å_Welcome to the Map Tour web application.<br />The story is not configured yet________________________ø.",
				appSave: "å_Error saving the story________ø",
			...
			builderHTML: {
				...
				dataEditionDisabled: "å_Editing data is disabled on this CSV data source_______________ø",
				...
				addMaxPointReached: "å_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________ø.",
				...
				settingsLayoutExplain: "å_Select the layout you want_________ø.",
				...
				dataTitle: "å_Create hosted Map Tour layer_________ø",
				dataExplain: "å_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________ø.",
				dataExplainPortal: "å_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________ø.",
				dataNameLbl: "å_Layer name____ø",
				...
				dataBtnSave: "å_Create the layer______ø",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "å_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________ø.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "å_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________ø.",
				hostedFsNA: "å_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________ø.",
				hostedFsNA2: "å_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________ø",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "å_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________ø",
			...
			locator: {
				error: "å_Location not available________ø"
			}
        }
    })
);
