	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "å_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________ø",
			...
			initPopupHome: {
				...
				hostedFsNA: "å_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________ø",
				hostedFsNA2: "å_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________ø.",
