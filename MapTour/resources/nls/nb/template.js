	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "å_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________ø.",
				noLayerMobile2: "å_Please rotate your device to landscape orientation to use the Map Tour builder_________________________ø.",
				...
				notAuthorizedBuilder: "å_You are not authorized to use Map Tour builder_______________ø.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "å_Loaded %NB_POINTS% points_________ø",
			...
			initPopupHome: {
				...
				hostedFsNA2: "å_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________ø",
			...
			share: {
				firstSaveTitle: "å_Tour saved____ø",
				...
				shareLinkHeader: "å_Share your Tour______ø",
				shareLinkOpen: "ÅPNE",
				shareA1: "å_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________ø.",
