	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "須_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________鷗",
			...
			initPopupHome: {
				...
				hostedFsNA: "須_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________鷗",
				hostedFsNA2: "須_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________鷗.",
