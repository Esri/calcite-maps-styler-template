...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "須_Start on point no._鷗"
			},
			builderHTML: {
				...
				organizeWarning: "須_One or multiple points added outside of the interactive builder are hidden._鷗",
				...
				dataPicError4: "須_This will add <i>#isImage</i> to the end of unsupported picture URLs. Most server support URL appendages. However, once you have performed that action, you should verify that the updated picture URLs are functional by navigating through your points. If each pictures loads, you can now save the Map Tour. If <b>pictures are broken, don’t save the Map Tour</b>. Instead, reload the builder and perform the second action._鷗",
				...
				addNoteVideo: "須_Consult Help for instructions on using videos_鷗",		
				addSelectCaptionNoFileReader: "須_Select picture_鷗",	
				...
				settingsLayoutLocBtnHelp: "須_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._鷗",
			...
			addPopupJS: {
				...
				uploadError2: "須_Error adding the feature (invalid html tag)_鷗",
				notJpg: "アップロードする JPEG の写真を選択してください",
				errorNoPhoto: "アップロードする画像を選択",
				errorNoThumbnail: "アップロードするサムネイルを選択",
				errorInvalidPicUrl: "須_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._鷗",
			...
			onlinePhotoSharingCommon: {
				pictures: "須_pictures_鷗",
				videos: "須_videos_鷗",
				disabled: "この機能は、管理者によって無効にされています",
				disabledPortal: "この機能は Portal for ArcGIS では無効になっています。",
				header1: "写真をパブリックに共有する必要があります。",
				header2: "須_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._鷗",
				...
				userLookingup: "検索",
				csv: "CSV で参照",
				advanced: "須_Advanced options_鷗",
				select: "選択",
				locUse: "写真の場所を使用",
				locUse2: "須_Use videos location_鷗",
			...
			viewYoutube: {
				header: "須_Look for publicly shared videos using an user name._鷗",
			...
			viewGeoTag: {
				header: "須_Click or tap the pictures you want to import to locate them._鷗",
			...
			initPopupHome: {
				header1: "須_Where are your medias?_鷗",
				header2: "このアシスタントを使用して、オンラインに保存された写真からマップ ツアーを構築したり、それらを ArcGIS Online for Organization アカウントにインポートしたりできます。",
				title1: "須_My medias are already hosted_鷗",
				title2: "写真をホストする必要があります",
				hostedFSTooltip: "須_Use ArcGIS Online to host your pictures (doesn't support videos)._鷗",
				...
				footer5: "須_Learn about hosting options_鷗",
