	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "須_The Map Tour builder is not supported at this display size___________________鷗.",
				noLayerView: "須_Welcome to the Map Tour web application.<br />The story is not configured yet________________________鷗.",
				appSave: "須_Error saving the story________鷗",
			...
			builderHTML: {
				...
				dataEditionDisabled: "須_Editing data is disabled on this CSV data source_______________鷗",
				...
				addMaxPointReached: "須_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________鷗.",
				...
				settingsLayoutExplain: "須_Select the layout you want_________鷗.",
				...
				dataTitle: "須_Create hosted Map Tour layer_________鷗",
				dataExplain: "須_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________鷗.",
				dataExplainPortal: "須_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________鷗.",
				dataNameLbl: "須_Layer name____鷗",
				...
				dataBtnSave: "須_Create the layer______鷗",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "須_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________鷗.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "須_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________鷗.",
				hostedFsNA: "須_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________鷗.",
				hostedFsNA2: "須_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________鷗",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "須_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________鷗",
			...
			locator: {
				error: "須_Location not available________鷗"
			}
        }
    })
);
