	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "須_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________鷗.",
				noLayerMobile2: "須_Please rotate your device to landscape orientation to use the Map Tour builder_________________________鷗.",
				...
				notAuthorizedBuilder: "須_You are not authorized to use Map Tour builder_______________鷗.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "須_Loaded %NB_POINTS% points_________鷗",
			...
			initPopupHome: {
				...
				hostedFsNA2: "須_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________鷗",
			...
			share: {
				firstSaveTitle: "須_Tour saved____鷗",
				...
				shareLinkHeader: "須_Share your Tour______鷗",
				shareLinkOpen: "オープン",
				shareA1: "須_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________鷗.",
