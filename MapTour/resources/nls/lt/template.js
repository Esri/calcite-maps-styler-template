	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Į_The Map Tour builder is not supported at this display size. If possible, resize your browser to access the builder or please build your story on a device with a larger screen______________________________________________________š.",
				noLayerMobile2: "Į_Please rotate your device to landscape orientation to use the Map Tour builder_________________________š.",
				...
				notAuthorizedBuilder: "Į_You are not authorized to use Map Tour builder_______________š.",
			...
			viewCSV: {
				...
				resultHeaderSuccess: "Į_Loaded %NB_POINTS% points_________š",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Į_Only available with an ArcGIS Online subscription. <a href='%LINK%'>Sign up for a free trial</a>______________________________š",
			...
			share: {
				firstSaveTitle: "Į_Tour saved____š",
				...
				shareLinkHeader: "Į_Share your Tour______š",
				shareLinkOpen: "ATIDARYTI",
				shareA1: "Į_Use %SHAREIMG% on <a href='%LINK1%' target='_blank'>the application item page</a>. If you also want to unshare the web map, use <a href='%LINK2%' target='_blank'>the web map item page</a>_________________________________________________________š.",
