	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Į_The Map Tour builder is not supported at this display size___________________š.",
				noLayerView: "Į_Welcome to the Map Tour web application.<br />The story is not configured yet________________________š.",
				appSave: "Į_Error saving the story________š",
			...
			builderHTML: {
				...
				dataEditionDisabled: "Į_Editing data is disabled on this CSV data source_______________š",
				...
				addMaxPointReached: "Į_You have reached the maximum number of points authorized by the icons set and cannot add another tour point.<br /><br />Note that if you delete existing points, you will need to reload the story____________________________________________________________š.",
				...
				settingsLayoutExplain: "Į_Select the layout you want_________š.",
				...
				dataTitle: "Į_Create hosted Map Tour layer_________š",
				dataExplain: "Į_A new Feature Layer will be created for your images and Tour points. The Tour layer won't be shared with anyone unless you share your Map Tour____________________________________________š.",
				dataExplainPortal: "Į_This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator____________________________________________š.",
				dataNameLbl: "Į_Layer name____š",
				...
				dataBtnSave: "Į_Create the layer______š",
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "Į_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database. Please contact your Portal for ArcGIS Administrator______________________________________________š.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "Į_Upload your images and store them with the Map Tour layer (doesn't support video)__________________________š.",
				hostedFsNA: "Į_You must be a Publisher or in another role with the privilege to publish hosted Feature Layers. Please contact your ArcGIS administrator__________________________________________š.",
				hostedFsNA2: "Į_Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>________________________________š",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "Į_The template produces an attractive, easy-to-use web application that lets you present a small set of places on a map in a numbered sequence through which users can browse. The template is designed to be used in any web browser on any device, including smartphones and tablets. <br /><br />________________________________________________________________________________________š",
			...
			locator: {
				error: "Į_Location not available________š"
			}
        }
    })
);
