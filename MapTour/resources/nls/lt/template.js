	 ...
	 ({
		viewer: {
			...
			onlinePhotoSharingCommon: {
				...
				disabledPortal: "Į_This feature require the Portal to have an ArcGIS Data Store configured as the managed Database______________________________š",
			...
			initPopupHome: {
				...
				hostedFsNA: "Į_Only available to ArcGIS Online organization member, <a href='%LINK%'>Sign up for a free trial</a>______________________________š",
				hostedFsNA2: "Į_This require Feature Service creation privilege. Please contact your ArcGIS Online Administrator______________________________š.",
