...
({
		viewer: {
			...
			desktopHTML: {
				...
				bitlyStartIndex: "Į_Start on point no._š"
			},
			builderHTML: {
				...
				organizeWarning: "Į_One or multiple points added outside of the interactive builder are hidden._š",
				...
				dataPicError4: "Į_This will add <i>#isImage</i> to the end of unsupported picture URLs. Most server support URL appendages. However, once you have performed that action, you should verify that the updated picture URLs are functional by navigating through your points. If each pictures loads, you can now save the Map Tour. If <b>pictures are broken, don’t save the Map Tour</b>. Instead, reload the builder and perform the second action._š",
				...
				addNoteVideo: "Į_Consult Help for instructions on using videos_š",		
				addSelectCaptionNoFileReader: "Į_Select picture_š",	
				...
				settingsLayoutLocBtnHelp: "Į_That functionality is supported on most mobile device and desktop browsers (Internet Explorer 9)._š",
			...
			addPopupJS: {
				...
				uploadError2: "Į_Error adding the feature (invalid html tag)_š",
				...
				errorInvalidPicUrl: "Į_Enter a valid picture (starts with http(s)://, ends with jpg, png, gif or bmp). You can end the URL with '#isImage' to override that rule._š",
			...
			onlinePhotoSharingCommon: {
				...
				header2: "Į_The import will be limited to the first %NB1% %MEDIA% to respect the limit of %NB2% points per tour._š",
				...
				advanced: "Į_Advanced options_š",
				select: "Pažymėti",
				locUse: "Naudoti paveikslų vietas",
				locUse2: "Į_Use videos location_š",
			...
			viewYoutube: {
				header: "Į_Look for publicly shared videos using an user name._š",
				pageInputLbl: "Į_Enter a Youtube user name_š",
				lookupMsgError: "Į_User not found_š",
				howToFind: "Į_How to find a Youtube user name_š",
				howToFind2: "Į_User name is displayed under videos_š",
				found: "Į_Found_š",
				noData: "Į_No public videos found_š"
			},
			viewGeoTag: {
				header: "Į_Click or tap the pictures you want to import to locate them._š",
			...
			initPopupHome: {
				header1: "Į_Where are your medias?_š",
				...
				title1: "Į_My medias are already hosted_š",
				title2: "Man reikia talpinti nuotraukas",
				hostedFSTooltip: "Į_Use ArcGIS Online to host your pictures (doesn't support videos)._š",
				...
				footer5: "Į_Learn about hosting options_š",
