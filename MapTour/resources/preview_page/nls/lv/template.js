...
({
		firstPane: {
			...
			list0: "Bildes tiek glabātas lielākajos tiešsaistes fotoattēlu koplietošanas servisos: Flickr, Picasa un Facebook vai jebkurā web serverī",
		...
		thirdPane: {
			...
			list0: "Lejupielādēt šablonu no <a href='http://storymaps.esri.com/templategallery/' target='_blank'>Story Maps šablonu lapas</a> un sekot iekļautajai dokumentācijai", 
			list1: "Mitiniet šablonu savā web serverī vai trešās puses serverī"
		},
		fourthPane: {
