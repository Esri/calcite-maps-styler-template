...
({
		firstPane: {
			...
			list0: "الصور المخزنة في خدمات مشاركة الصور الرئيسية: Flickr أو Picasa أو Facebook أو أي خادم ويب آخر",
		...
		thirdPane: {
			...
			list0: "تنزيل القالب من <a href='http://storymaps.esri.com/templategallery/' target='_blank'>صفحة قالب خرائط القصص</a> واتبع الوثائق المتضمنة". 			list1: "استضافة القالب على خادم الويب أو على خادم ثلاثي الأبعاد."
		},
		fourthPane: {
