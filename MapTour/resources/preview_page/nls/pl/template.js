...
({
		firstPane: {
			...
			list0: "obrazów przechowywanych w najpopularniejszych serwisach udostępniających zdjęcia: Flickr, Picasa i Facebook oraz na dowolnym serwerze internetowym",
		...
		thirdPane: {
			...
			list0: "Pobrać szablon <a href='http://storymaps.esri.com/templategallery/' target='_blank'>ze strony szablonów map ze scenariuszami</a> i postępować zgodnie z instrukcjami w załączonej dokumentacji", 
			list1: "Umieść szablon na własnym serwerze WWW lub innym serwerze zewnętrznym"
		},
		fourthPane: {
