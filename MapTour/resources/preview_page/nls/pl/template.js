...
({
		firstPane: {
			...
			list0: "Obrazy przechowywane w najpopularniejszych serwisach udostępniających zdjęcia, takich jak: Flickr, Picasa i Facebook oraz na dowolnej witrynie lub serwerze internetowym",
		...
		thirdPane: {
			...
			list0: "Należy pobrać szablon <a href='http://storymaps.esri.com/templategallery/' target='_blank'>ze strony szablonów map ze scenariuszami</a> i postępować zgodnie z instrukcjami w załączonej dokumentacji".", 
