define(
	 ({
		firstPane: {
			...
			list1: "Bilder som ännu inte finns lagrade online och som kommer att lagras som bilagor till geoobjektstjänster (begränsat till ArcGIS for Organizations-medlemmar)"
		},
		secondPane: {
