...
({
		firstPane: {
			...
			list0: "Bilder som finns lagrade på större onlinefotodelningstjänster: Flickr, Picasa och Facebook, eller på en webbserver",
		...
		thirdPane: {
			...
			list1: "Drifta mallen på en egen webbserver eller server från tredje part"
		},
		fourthPane: {
