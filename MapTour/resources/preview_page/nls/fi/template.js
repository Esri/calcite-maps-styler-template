...
({
		firstPane: {
			...
			list0: "merkittäviin kuvanjakopalveluihin, kuten Flickriin, Picassan ja Facebookiin, tai johonkin verkkopalvelimeen tallennetut kuvat",
		...
		thirdPane: {
			...
			list1: "Isännöi mallia omassa tai kolmannen osapuolen web-palvelimessa"
		},
		fourthPane: {
