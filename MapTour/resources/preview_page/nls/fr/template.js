...
({
		firstPane: {
			...
			list0: "des images stockées dans des services de partage de photos en ligne : Flickr, Picasa et Facebook ou sur n\'importe quel serveur Web ;",
		...
		thirdPane: {
			...
			list0: "Télécharger le modèle depuis la <a href='http://storymaps.esri.com/templategallery/' target='_blank'>page des modèles des cartes de narration</a> et consulter la documentation incluse 
