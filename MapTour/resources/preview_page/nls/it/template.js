...
({
		firstPane: {
			...
			list0: "Immagini archiviate nei principali servizi di condivisione di immagini, come Flickr, Picasa e Facebook, o su qualsiasi server Web",
		...
		thirdPane: {
			...
			list1: \"Ospitare il modello nel proprio server Web o in un server di terzi"
		},
		fourthPane: {
