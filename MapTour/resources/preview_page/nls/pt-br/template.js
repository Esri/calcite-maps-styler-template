...
({
		firstPane: {
			...
			list0: "Figuras armazenadas em serviços de compartilhamento de fotos online maiores: Flickr, Picasa e Facebook ou em qualquer servidor da web",
		...
		thirdPane: {
			...
			list0: "Baixar o modelo de uma <a href='http://storymaps.esri.com/templategallery/' target='_blank'>página do modelo Mapas Históricos</a>e seguir a documentação incluída", 
			list1: "Hospedar o modelo no seu próprio servidor da web ou em um servidor de terceiro"
		},
		fourthPane: {
