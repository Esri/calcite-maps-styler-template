...
define({
    ...
    "urlItems": ["extent", "home", "zoom", "scale", "search", "basemap_toggle", "basemap_gallery", "alt_basemap", "legend", "popup_sidepanel", "details", "theme", "searchextent", "marker", "level", "center", "active_panel", "show_panel", "find", "feature", "disable_scroll", "zoom_position", "logoimage", "logolink"] // example param. ?theme=<my theme>
});