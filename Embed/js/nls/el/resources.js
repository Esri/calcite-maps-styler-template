     ...
     ({
        "tools":{
            ...
            "basemap":{
                    ...
                    "title": "Επιλέξτε έναν βασικό χάρτη"
            },
            "legend":{
                "title": "Υπόμνημα"
            },
            "details":{
                "title": "Đ_Details_ớ",
                "error": "Ενημερώστε την περιγραφή του χάρτη web με τις λεπτομέρειες που θα εμφανίζονται σε αυτή την ενότητα."
            },
            "popup": {
                "title": "Πληροφορίες",
                "instructions": "Επιλέξτε ένα χαρακτηριστικό στο χάρτη για να δείτε λεπτομέρειες."
            }
